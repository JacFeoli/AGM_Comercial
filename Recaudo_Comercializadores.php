...
<head>
    <title>AGM - Recaudo Comercializadores</title>
    <meta charset="UTF-8" />
...
<!--Fin Upload Modal-->
<!--Eliminar Recaudo Comercializadores Modal-->
<div class="modal fade" id="modalEliminarRecaComer" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">
                ...
                <h4 class="modal-title">Eliminar Recaudo Comercializadores</h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-sm font background-default cursor" data-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-danger btn-sm font background-danger cursor" id="eliminar_reca_comer" name="eliminar_reca_comer"><i class="fas fa-trash-alt fa-fw"></i> Eliminar</button>
            </div>
        </div>
    </div>
</div>
<!--Fin Eliminar Recaudo Comercializadores Modal-->
                    ...
                    <div class="col-lg-12">
                        <div class="content">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="rightcol">
                                        <h1>Recaudo Comercializadores</h1>
                                        <h2></h2>
                                        <ul class="nav nav-pills" role="tablist">
                                            <li role="presentation" class="active">
                                                <a href="#informacion_reca_comercializadores_tab" id="tab_info_reca_comercializadores" aria-controls="informacion_reca_comercializadores_tab" role="tab" data-toggle="tab">Información Reca. Comercializadores</a>
                                            </li>
                                            <li role="presentation">
                                                <a href="#crear_reca_comercializadores_tab" id="tab_crear_reca_comercializadores" aria-controls="crear_reca_comercializadores_tab" role="tab" data-toggle="tab">Crear Reca. Comercializador</a>
                                            </li>
                                            <?php
                                            if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                <li role="presentation">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="informacion_reca_comercializadores_tab">
                                                <input class="form-control input-text input-sm" type="text" placeholder="Buscar Recaudo" name="buscar_recaudo" id="buscar_recaudo" />
                                                <br />
                                                <?php
                                                $query_select_reca_comer = "SELECT * FROM recaudo_comercializadores_2 ORDER BY ID_FACTURACION DESC";
                                                $sql_reca_comer = mysqli_query($connection, $query_select_reca_comer);
                                                if (mysqli_num_rows($sql_reca_comer) != 0) {
                                                    ...
                                                    echo "<th width=38%>COMERCIALIZADOR</th>";
                                                    ...
                                                    echo "</tr>";
                                                    echo "</thead>";
                                                    echo "<tbody id='resultado_reca_comer'>";
                                                    ...
                                                    echo "<p class='message'>No se encontraron Recaudos Comercializadores Creados.</p>";
                                                }
                                                ?>
                                                <div id="div-pagination">
                                                    <ul id="pagination-reca_comer"></ul>
                                                    <span id='loading-spinner' style='display: none; float: right;'><img src='Images/squares.gif' /></span>
                                                </div>
                                            </div>
                                            <div role="tabpanel" class="tab-pane fade" id="crear_reca_comercializadores_tab">
                                                <?php
                                                if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                    <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_reca_comercializador" name="crear_reca_comercializador" action="<?php echo "Modelo/Crear_Reca_Comer.php?editar=" . $_GET['id_reca_comercializador_editar']; ?>" method="post">
                                                        <?php
                                                        $query_select_reca_comercializador = mysqli_query($connection, "SELECT * FROM recaudo_comercializadores_2 WHERE ID_RECAUDO = " . $_GET['id_reca_comercializador_editar']);
                                                        $row_reca_comercializador = mysqli_fetch_array($query_select_reca_comercializador);
                                                        ?>
                                                        <input type="hidden" id="id_reca_comercializador_editar_hidden" name="id_reca_comercializador_editar_hidden" value="<?php echo $row_reca_comercializador['ID_RECAUDO']; ?>" />
                                                        <?php
                                                    } else {
                                                        if (isset($_GET['id_reca_comercializador_eliminar'])) { ?>
                                                            <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_reca_comercializador" name="crear_reca_comercializador" action="<?php echo "Modelo/Crear_Reca_Comer.php?eliminar=" . $_GET['id_reca_comercializador_eliminar']; ?>" method="post">
                                                                <?php
                                                                $query_select_reca_comercializador = mysqli_query($connection, "SELECT * FROM recaudo_comercializadores_2 WHERE ID_RECAUDO = " . $_GET['id_reca_comercializador_eliminar']);
                                                                $row_reca_comercializador = mysqli_fetch_array($query_select_reca_comercializador);
                                                                ?>
                                                                <input type="hidden" id="id_reca_comercializador_eliminar_hidden" name="id_reca_comercializador_eliminar_hidden" value="<?php echo $row_reca_comercializador['ID_RECAUDO']; ?>" />
                                                            <?php
                                                        } else { ?>
                                                                <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_reca_comercializador" name="crear_reca_comercializador" action="<?php echo "Modelo/Crear_Reca_Comer.php"; ?>" method="post">
                                                                <?php
                                                            }
                                                                ?>
                                                            <?php
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-xs-3">
                                                                    <div class="input-group date" id="fecha_recaudo" data-toogle="tooltip" title="FECHA RECAUDO">
                                                                        <?php
                                                                        if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                                            <input type="text" class="form-control input-text input-sm" name="fecha_recaudo" value="<?php echo $row_reca_comercializador['FECHA_RECAUDO'] ?>" placeholder="Fecha Recaudo" required="required" onkeypress="return isNothing(event)" onkeydown="return isNothing(event)" />
                                                                ...
                                                                <div class="col-xs-3">
                                                                    <div class="input-group date" id="fecha_pago_bitacora" data-toogle="tooltip" title="FECHA BITACORA">
                                                                        <?php
                                                                        if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                                            <input type="text" class="form-control input-text input-sm" name="fecha_pago_bitacora" value="<?php echo $row_reca_comercializador['FECHA_PAGO_BITACORA'] ?>" placeholder="Fecha Bitacora" required="required" onkeypress="return isNothing(event)" onkeydown="return isNothing(event)" />
                                                                            <span class="input-group-addon">
                                                                                <span class="far fa-calendar-alt"></span>
                                                                            </span>
                                                                            <?php
                                                                        ...
                                                                        if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                                            <select class="form-control input-text input-sm" id="estado_recaudo" name="estado_recaudo" data-toggle="tooltip" title="ESTADO RECAUDO" required>
                                                                                ...
                                                                                if (isset($_GET['id_reca_comercializador_eliminar'])) { ?>
                                                                                    ...
                                                                                    <?php
                                                                                    if (isset($_GET['id_reca_comercializador_editar']) || isset($_GET['id_reca_comercializador_eliminar'])) { ?>
                                                                                        <input type="hidden" id="estado_recaudo_hidden" name="estado_recaudo_hidden" value="<?php echo $row_reca_comercializador['ESTADO_RECAUDO']; ?>" />
                                                                                    <?php
                                                                                    }
                                                                                    ?>
                                                                                        </select>
                                                                ...
                                                                <div class="col-xs-7">
                                                                    ...
                                                                    if (isset($_GET['id_reca_comercializador_editar'])) {
                                                                        $query_select_comercializador = mysqli_query($connection, "SELECT * "
                                                                            . "  FROM comercializadores_2 C, "
                                                                            . "       facturacion_comercializadores_2 FC, "
                                                                            . "       recaudo_comercializadores_2 RC "
                                                                            . " WHERE RC.ID_FACTURACION = FC.ID_FACTURACION "
                                                                            . "   AND FC.ID_COMERCIALIZADOR = C.ID_COMERCIALIZADOR "
                                                                            . "   AND RC.ID_FACTURACION = " . $row_reca_comercializador['ID_FACTURACION']);
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <input type="text" class="form-control input-text input-sm" id="comercializador" name="comercializador" value="<?php echo $row_comercializador['NOMBRE']; ?>" placeholder="Comercializador" required="required" data-toggle="tooltip" readonly="readonly" title="COMERCIALIZADOR" onclick="comercializadorReca()" />
                                                                        <?php
                                                                    } else {
                                                                        if (isset($_GET['id_reca_comercializador_eliminar'])) {
                                                                            $query_select_comercializador = mysqli_query($connection, "SELECT * "
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            <input type="text" class="form-control input-text input-sm" id="comercializador" name="comercializador" placeholder="Comercializador" required="required" data-toggle="tooltip" readonly="readonly" title="COMERCIALIZADOR" onclick="comercializadorReca()" />
                                                                    <?php
                                                                        }
                                                                    }
                                                                    ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-xs-3">
                                                                    ...
                                                                    if (isset($_GET['id_reca_comercializador_editar'])) {
                                                                        $query_select_departamento = mysqli_query($connection, "SELECT * "
                                                                            . "  FROM departamentos_comercializadores_2 "
                                                                            . " WHERE ID_COMERCIALIZADOR = " . $row_comercializador['ID_COMERCIALIZADOR'] . " "
                                                                            . "   AND ID_DEPARTAMENTO = " . $row_comercializador['ID_COD_DPTO']);
                                                                ...
                                                                <div class="col-xs-3">
                                                                    ...
                                                                    if (isset($_GET['id_reca_comercializador_editar'])) {
                                                                        $query_select_municipio = mysqli_query($connection, "SELECT * "
                                                                            ...
                                                                            . " WHERE ID_COMERCIALIZADOR = " . $row_comercializador['ID_COMERCIALIZADOR'] . " "
                                                                            . "   AND ID_DEPARTAMENTO = " . $row_comercializador['ID_COD_DPTO'] . " "
                                                                            . "   AND ID_MUNICIPIO = " . $row_comercializador['ID_COD_MPIO']);
                                                                ...
                                                                <div class="col-xs-3">
                                                                    <?php
                                                                    if (isset($_GET['id_reca_comercializador_editar'])) {
                                                                        $query_select_info_facturacion = mysqli_query($connection, "SELECT * FROM facturacion_comercializadores_2 WHERE ID_FACTURACION = " . $row_reca_comercializador['ID_FACTURACION']);
                                                                ...
                                                                <div class="col-xs-3">
                                                                    <div class="input-group" id="valor_energia" data-toogle="tooltip" title="VALOR ENERGÍA">
                                                                        ...
                                                                        if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                                            ...
                                                                            <input type="text" class="form-control input-text input-sm" name="valor_energia" value="<?php echo round($row_info_facturacion['VALOR_ENERGIA'], 1); ?>" maxlength="25" readonly="readonly" placeholder="Valor Energía" onblur="convertValorEnergia();" onchange="return convertValorEnergia()" onkeypress="return isNumeric(event)" />
                                                                            <?php
                                                                        } else {
                                                                            if (isset($_GET['id_reca_comercializador_eliminar'])) { ?>
                                                                                <span class="input-group-addon">
                                                                                ...
                                                                                <input type="text" class="form-control input-text input-sm" name="valor_energia" value="<?php echo round($row_info_facturacion['VALOR_ENERGIA'], 1); ?>" readonly="readonly" placeholder="Valor Energía" onblur="convertValorEnergia();" onchange="return convertValorEnergia()" onkeypress="return isNumeric(event)" />
                                                                            <?php
                                                                            } else { ?>
                                                                                <span class="input-group-addon">
                                                                                    <span class="fas fa-dollar-sign"></span>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-xs-3">
                                                                    <div class="input-group" id="nota_fiducia" data-toogle="tooltip" title="NOTA FIDUCIA">
                                                                        ...
                                                                        if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                                            ...
                                                                            <input type="text" class="form-control input-text input-sm" name="nota_fiducia" value="<?php echo $row_reca_comercializador['NOTA_FIDUCIA'] ?>" maxlength="10" required="required" placeholder="Nota Fiducia" onkeypress="return isNumeric(event)" />
                                                                            <?php
                                                                        } else {
                                                                            if (isset($_GET['id_reca_comercializador_eliminar'])) { ?>
                                                                                <span class="input-group-addon">
                                                                                ...
                                                                                <input type="text" class="form-control input-text input-sm" name="nota_fiducia" value="<?php echo $row_reca_comercializador['NOTA_FIDUCIA'] ?>" placeholder="Nota Fiducia" onkeypress="return isNumeric(event)" />
                                                                            <?php
                                                                            } else { ?>
                                                                                <span class="input-group-addon">
                                                                                    <span class="fas fa-hashtag"></span>
                                                                ...
                                                                <div class="col-xs-3">
                                                                    <div class="input-group date" id="fecha_fiducia" data-toogle="tooltip" title="FECHA FIDUCIA">
                                                                        <?php
                                                                        if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                                            <input type="text" class="form-control input-text input-sm" name="fecha_fiducia" value="<?php echo $row_reca_comercializador['FECHA_FIDUCIA'] ?>" placeholder="Fecha Fiducia" required="required" onkeypress="return isNothing(event)" onkeydown="return isNothing(event)" />
                                                                            <span class="input-group-addon">
                                                                                <span class="far fa-calendar-alt"></span>
                                                                            </span>
                                                                            <?php
                                                                            ...
                                                                            if (isset($_GET['id_reca_comercializador_eliminar'])) { ?>
                                                                                <input type="text" class="form-control input-text input-sm" name="fecha_fiducia" value="<?php echo $row_reca_comercializador['FECHA_FIDUCIA'] ?>" placeholder="Fecha Fiducia" onkeypress="return isNothing(event)" onkeydown="return isNothing(event)" />
                                                                                <span class="input-group-addon">
                                                                                    <span class="far fa-calendar-alt"></span>
                                                                                </span>
                                                                            <?php
                                                                ...
                                                                <div class="col-xs-3">
                                                                    <div class="input-group date" id="fecha_aplicacion_encargo" data-toogle="tooltip" title="FECHA APL. ENCARGO">
                                                                        <?php
                                                                        if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                                            <input type="text" class="form-control input-text input-sm" name="fecha_aplicacion_encargo" value="<?php echo $row_reca_comercializador['FECHA_APL_ENCARGO'] ?>" placeholder="Fecha Apl. Encargo" required="required" onkeypress="return isNothing(event)" onkeydown="return isNothing(event)" />
                                                                            <span class="input-group-addon">
                                                                                <span class="far fa-calendar-alt"></span>
                                                                            </span>
                                                                            <?php
                                                                            ...
                                                                            if (isset($_GET['id_reca_comercializador_eliminar'])) { ?>
                                                                                <input type="text" class="form-control input-text input-sm" name="fecha_aplicacion_encargo" value="<?php echo $row_reca_comercializador['FECHA_APL_ENCARGO'] ?>" placeholder="Fecha Apl. Encargo" onkeypress="return isNothing(event)" onkeydown="return isNothing(event)" />
                                                                                <span class="input-group-addon">
                                                                                    <span class="far fa-calendar-alt"></span>
                                                                                </span>
                                                                            <?php
                                                                ...
                                                                <div class="col-xs-3">
                                                                    <div class="input-group" id="valor_recaudo" data-toogle="tooltip" title="VALOR RECAUDO">
                                                                        ...
                                                                        if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                                            ...
                                                                            <input type="text" class="form-control input-text input-sm" name="valor_recaudo" value="<?php echo $row_reca_comercializador['VALOR_RECAUDO'] ?>" maxlength="25" placeholder="Valor Recaudo" required="required" onblur="convertValorRecaudo(); calcularValorSaldoFecha();" onchange="return convertValorRecaudo()" onkeypress="return isNumeric(event)" />
                                                                            <?php
                                                                        } else {
                                                                            if (isset($_GET['id_reca_comercializador_eliminar'])) { ?>
                                                                                <span class="input-group-addon">
                                                                                ...
                                                                                <input type="text" class="form-control input-text input-sm" name="valor_recaudo" value="<?php echo $row_reca_comercializador['VALOR_RECAUDO'] ?>" readonly="readonly" placeholder="Valor Recaudo" onblur="convertValorRecaudo(); calcularValorSaldoFecha();" onchange="return convertValorRecaudo()" onkeypress="return isNumeric(event)" />
                                                                            <?php
                                                                            } else { ?>
                                                                                <span class="input-group-addon">
                                                                                    <span class="fas fa-dollar-sign"></span>
                                                                ...
                                                                <div class="col-xs-3">
                                                                    <div class="input-group" id="saldo_fecha" data-toogle="tooltip" title="SALDO A LA FECHA">
                                                                        ...
                                                                        if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                                            ...
                                                                            <input style="text-align: center;" type="text" class="form-control input-text input-sm" name="saldo_fecha" value="<?php echo $row_info_facturacion['VALOR_FACTURA'] - $row_reca_comercializador['VALOR_RECAUDO']; ?>" maxlength="25" readonly="readonly" placeholder="Saldo Fecha" onblur="return convertSaldoFecha()" onchange="return convertSaldoFecha()" />
                                                                            <?php
                                                                        } else {
                                                                            if (isset($_GET['id_reca_comercializador_eliminar'])) { ?>
                                                                                <span class="input-group-addon">
                                                                                ...
                                                                                <input style="text-align: center;" type="text" class="form-control input-text input-sm" name="saldo_fecha" value="<?php echo $row_info_facturacion['VALOR_FACTURA'] - $row_reca_comercializador['VALOR_RECAUDO']; ?>" readonly="readonly" placeholder="Saldo Fecha" onblur="return convertSaldoFecha()" onchange="return convertSaldoFecha()" />
                                                                            <?php
                                                                            } else { ?>
                                                                                <span class="input-group-addon">
                                                                                    <span class="fas fa-dollar-sign"></span>
                                                            ...
                                                            <div style="margin-bottom: 0px;" class="form-group">
                                                                <div style="text-align: center;" class="col-xs-12">
                                                                    <?php
                                                                    if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                                        <button class="btn btn-primary btn-sm font background cursor" id="btn_crear_recaudo_comercializador" type="submit"><i style="font-size: 14px;" class="fas fa-save"></i>&nbsp;&nbsp;Actualizar Recaudo Comer.</button>&nbsp;&nbsp;
                                                                        <button type="reset" class="btn btn-danger btn-sm font background-danger cursor" onclick="document.location.href = 'Recaudo_Comercializadores.php'"><i style="font-size: 14px;" class="fas fa-times"></i>&nbsp;&nbsp;Cancelar</button>
                                                                        <?php
                                                                    } else {
                                                                        if (isset($_GET['id_reca_comercializador_eliminar'])) { ?>
                                                                            <button class="btn btn-primary btn-sm font background cursor" id="btn_crear_recaudo_comercializador" type="button" data-toggle="modal" data-target="#modalEliminarRecaComer"><i style="font-size: 14px;" class="fas fa-save"></i>&nbsp;&nbsp;Eliminar Recaudo Comer.</button>&nbsp;&nbsp;
                                                                            <button type="reset" class="btn btn-danger btn-sm font background-danger cursor" onclick="document.location.href = 'Recaudo_Comercializadores.php'"><i style="font-size: 14px;" class="fas fa-times"></i>&nbsp;&nbsp;Cancelar</button>
                                                                        <?php
                                                                        } else { ?>
                                                                            <button class="btn btn-primary btn-sm font background cursor" id="btn_crear_recaudo_comercializador" type="button"><i style="font-size: 14px;" class="fas fa-save"></i>&nbsp;&nbsp;Crear Recaudo Comer.</button>&nbsp;&nbsp;
                                                                            <button type="reset" class="btn btn-danger btn-sm font background-danger cursor" onclick="return resetFieldRecaudoComercializador();"><i style="font-size: 14px;" class="fas fa-times"></i>&nbsp;&nbsp;Cancelar</button>
                                                                    <?php
                                                                        }
                                                                    }
                                                                    ?>
                                            ...
                                            if (isset($_GET['id_reca_comercializador_editar'])) { ?>
                                                <div role="tabpanel" class="tab-pane fade" id="cargar_soporte_recaudo_tab">
                                                    <form class="form-horizontal row-bottom-buffer row-top-buffer" id="cargar_soporte_recaudo" name="cargar_soporte_recaudo" action="Modelo/Subir_Archivos.php?archivo=recaudo_comercializador" method="post" enctype="multipart/form-data">
                                                        <input type="hidden" name="id_tabla_archivo" id="id_tabla_archivo" value="<?php echo $_GET['id_reca_comercializador_editar']; ?>" />
                                                    ...
                                                    $query_select_nombre_municipio = mysqli_query($connection, "SELECT NOMBRE FROM municipios_visitas_2 "
                                                        . " WHERE ID_DEPARTAMENTO = " . $row_comercializador['ID_COD_DPTO'] . ""
                                                        . "   AND ID_MUNICIPIO = " . $row_comercializador['ID_COD_MPIO']);
                                                    $row_nombre_municipio = mysqli_fetch_array($query_select_nombre_municipio);
                                                    $path = "Files/" . $row_nombre_municipio['NOMBRE'] . "/";
                                                    $query_select_files_recaudo_comercializadores = mysqli_query($connection, "SELECT * "
                                                        . "  FROM recaudo_comercializadores_archivos_2 "
                                                        . " WHERE ID_TABLA_RECAUDO = " . $_GET['id_reca_comercializador_editar']);
                                                    if (mysqli_num_rows($query_select_files_recaudo_comercializadores) != 0) {
                                                        while ($row_files = mysqli_fetch_assoc($query_select_files_recaudo_comercializadores)) {
                                                        ...
                                                        if ($handle = opendir($path)) {
                                                            foreach (array_combine($info_id_recaudo, $info_recaudo) as $id_files => $files) {
                                                                ...
                                                                $theList .= "<tr>"
                                                                    ...
                                                                    . "   <td style='vertical-align: middle;'><a href='Modelo/Eliminar_Archivos.php?file=" . $files . "&id_tabla_archivo=" . $_GET['id_reca_comercializador_editar'] . "&file_id=" . $id_files . "&archivo=recaudo_comercializador'><button><img src='Images/gnome_edit_delete.png' title='Eliminar' width='16' height='16' /></button></a></td>"
                                                                    . "</tr>";
                                                            }
                                                            closedir($handle);
                                                        }
...
<script>
    function resetFieldRecaudoComercializador() {
        $("#id_departamento").val("");
        $("#id_municipio").val("");
        $("#id_ano_fact").val("");
        $("#id_mes_fact").val("");
    ...
    //POPUPS
    function infoComercializadorReca(id_comercializador, comercializador, nit_comercializador) {
    ...
    function comercializadorReca() {
        window.open("Combos/Comercializador_Recaudo.php", "Popup", "width=500, height=500");
    }
    ...
    function tipoDepartamento(id_consulta) {
        ...
        window.open("Combos/Tipo_Departamento_Recaudo_Comercializador.php?id_consulta=" + id_consulta + "&id_comercializador=" + id_comercializador, "Popup", "width=400, height=500");
    }
    ...
    function tipoMunicipio(id_consulta) {
        ...
        window.open("Combos/Tipo_Municipio_Recaudo_Comercializador.php?id_departamento=" + id_departamento + "&id_consulta=" + id_consulta + "&id_comercializador=" + id_comercializador, "Popup", "width=400, height=500");
    }

    function infoPeriodoReca(id_facturacion, periodo_factura, valor_factura, valor_recaudo_fact, valor_energia, valor_favor, ajuste_fact, ajuste_reca, cuota_energia, consumo, otros_ajustes, no_usuarios) {
    ...
    function periodoReca() {
        ...
        window.open("Combos/Periodo_Reca_Comer.php?id_comercializador=" + id_comercializador + "&id_departamento=" + id_departamento + "&id_municipio=" + id_municipio, "Popup", "width=400, height=500");
    }
    //END POPUPS
</script>
<script>
    $(document).ready(function() {
        ...
        var id_reca_comercializador_editar = $("#id_reca_comercializador_editar_hidden").val();
        var id_reca_comercializador_eliminar = $("#id_reca_comercializador_eliminar_hidden").val();
        if (id_reca_comercializador_editar != undefined) {
            convertValorFactura();
            convertAjusteFact();
            convertTotalFactura();
            convertValorRecaudoFact();
            ...
            $(".nav-pills a[href='#crear_reca_comercializadores_tab']").tab("show");
            $(".nav-pills a[href='#crear_reca_comercializadores_tab']").text("Actualizar Reca. Comercializador");
            $("#estado_recaudo").val($("#estado_recaudo_hidden").val());
        } else {
            if (id_reca_comercializador_eliminar != undefined) {
                convertValorFactura();
                convertAjusteFact();
                convertTotalFactura();
                convertValorRecaudoFact();
                ...
                calcularValorSaldoFecha();
                $(".nav-pills a[href='#crear_reca_comercializadores_tab']").tab("show");
                $(".nav-pills a[href='#crear_reca_comercializadores_tab']").text("Eliminar Reca. Comercializador");
                $("#estado_recaudo").val($("#estado_recaudo_hidden").val());
            }
        }
        $("#buscar_recaudo").keypress(function(e) {
            if (e.which == 13) {
                ...
                $.ajax({
                    type: "POST",
                    url: "Modelo/Cargar_Paginacion_Reca_Comer.php",
                    dataType: "json",
                    data: "sw=1&busqueda_recaudo=" + busqueda_recaudo,
                    success: function(data) {
                        $("#pagination-reca_comer").twbsPagination('destroy');
                        $("#pagination-reca_comer").twbsPagination({
                            totalPages: data[0],
                            visiblePages: 15,
                            ...
                            onPageClick: function(event, page) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "Modelo/Cargar_Reca_Comer.php",
                                    dataType: "json",
                                    data: "sw=1&busqueda_recaudo=" + data[1] + "&page=" + page,
                                    success: function(data) {
                                        $("#loading-spinner").css('display', 'none');
                                        $("#resultado_reca_comer").html(data[0]);
                                    }
                                });
                            }
                        });
        ...
        $("#tab_info_reca_comercializadores").on("shown.bs.tab", function() {
            $("#buscar_recaudo").focus();
        });
        $("#tab_crear_reca_comercializadores").on("shown.bs.tab", function() {
            $("#comercializador").focus();
        });
        $("#tab_info_reca_comercializadores").on("click", function() {
            $("#buscar_recaudo").focus();
        });
        $("#tab_crear_reca_comercializadores").on("click", function() {
            $("#comercializador").focus();
        });
        if (id_reca_comercializador_editar == undefined && id_reca_comercializador_eliminar == undefined) {
            $("#btn_crear_recaudo_comercializador").click(function() {
                ...
                $("#btn_crear_recaudo_comercializador").attr("disabled", true);
                $("#btn_crear_recaudo_comercializador").css("pointer-events", "none");
                $("#btn_crear_recaudo_comercializador").html("Creando Reca. Comercializador...");
                $.ajax({
                    type: "POST",
                    ...
                    url: "Modelo/Crear_Reca_Comer.php",
                    success: function(data) {
                        //alert(data);
                        //$("#observaciones").val(data);
                        document.location.href = 'Recaudo_Comercializadores.php?id_reca_comercializador_editar=' + data;
                    }
                });
            });
        }
