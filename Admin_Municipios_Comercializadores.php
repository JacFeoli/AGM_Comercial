...
<html>
    <head>
        <title>AGM - Admin. Municipios Comercializadores</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="rightcol">
                                            <h1>Admin. Municipios Comercializadores</h1>
                                            <h2></h2>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_municipio_tab">
                                                    ...
                                                    <?php
                                                        $query_select_municipios = "SELECT * "
                                                                                   . "FROM municipios_comercializadores_2 MUN, departamentos_comercializadores_2 DEP "
                                                                ...
                                                                echo "<table class='table table-condensed table-hover'>";
                                                                    echo "<thead>";
                                                                        echo "<tr>";
                                                                            ...
                                                                            echo "<th width=52%>COMERCIALIZADOR</th>";
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="crear_municipio_tab">
                                                    <?php
                                                        if (isset($_GET['id_municipio_editar'])) { ?>
                                                            <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_municipio" name="crear_municipio" action="<?php echo "Modelo/Crear_Admin_Municipio_Comercializador.php?editar=" . $_GET['id_municipio_editar']; ?>" method="post">
                                                        <?php
                                                            $query_select_municipio = mysqli_query($connection, "SELECT * FROM municipios_comercializadores_2 WHERE ID_TABLA = " . $_GET['id_municipio_editar']);
                                                        ...
                                                        <?php
                                                            ...
                                                            if (isset($_GET['id_municipio_eliminar'])) { ?>
                                                                <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_municipio" name="crear_municipio" action="<?php echo "Modelo/Crear_Admin_Municipio_Comercializador.php?eliminar=" . $_GET['id_municipio_eliminar']; ?>" method="post">
                                                            <?php
                                                                $query_select_municipio = mysqli_query($connection, "SELECT * FROM municipios_comercializadores_2 WHERE ID_TABLA = " . $_GET['id_municipio_eliminar']);
                                                                $row_municipio = mysqli_fetch_array($query_select_municipio);
                                                            ?>
                                                            ...
                                                            <?php
                                                                ...
                                                                <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_municipio" name="crear_municipio" action="<?php echo "Modelo/Crear_Admin_Municipio_Comercializador.php"; ?>" method="post">
                                                            <?php
                                                            }
                                                            ?>
                                                        <?php
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-3">
                                                                <?php
                                                                    if (isset($_GET['id_municipio_editar'])) {
                                                                        $query_select_departamento = mysqli_query($connection, "SELECT * FROM departamentos_visitas_2 WHERE ID_DEPARTAMENTO = " . $row_municipio['ID_DEPARTAMENTO']);
                                                        ...
                                                        <div class="form-group">
                                                            <label style="text-align: left; padding-top: 4px; white-space: nowrap;" class="col-xs-1 control-label row-label" for="id_municipio">ID. Mpio.:</label>
                                                            <div class="col-xs-3">
                                                                <?php
                                                                    if (isset($_GET['id_municipio_editar'])) { ?>
                                                            ...
                                                            <label style="text-align: left; padding-top: 4px; white-space: nowrap;" class="col-xs-1 control-label row-label" for="id_municipio">Mpio.:</label>
                                                            <div class="col-xs-7">
                                                                <?php
                                                                    if (isset($_GET['id_municipio_editar'])) { ?>
                                                            ...
                                                            <div style="text-align: center;" class="col-xs-12">
                                                                <?php
                                                                    if (isset($_GET['id_municipio_editar'])) { ?>
                                                                        ...
                                                                        <button type="reset" class="btn btn-danger btn-sm font background-danger cursor" onclick="document.location.href = 'Admin_Municipios_Comercializadores.php'"><i style="font-size: 14px;" class="fas fa-times"></i>&nbsp;&nbsp;Cancelar</button>
                                                                    <?php
                                                                    } else {
                                                                        if (isset($_GET['id_municipio_eliminar'])) { ?>
        ...
        $(document).ready(function() {
            ...
            $("#buscar_municipio").keypress(function(e) {
                if (e.which == 13) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Modelo/Cargar_Paginacion_Admin_Municipio_Comercializador.php",
                        dataType: "json",
                        ...
                        success: function(data) {
                            ...
                            $("#pagination-municipio").twbsPagination({
                                ...
                                onPageClick: function (event, page) {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "Modelo/Cargar_Admin_Municipio_Comercializador.php",
                                        dataType: "json",
            ...
            if (id_municipio_editar == undefined && id_municipio_eliminar == undefined) {
                $("#btn_crear_municipio").click(function() {
                    ...
                    $.ajax({
                        type: "POST",
                        data: "id_comercializador="+id_comercializador+"&id_departamento="+id_departamento+
                              "&id_municipio="+id_municipio+"&nombre_municipio="+nombre_municipio,
                        url: "Modelo/Crear_Admin_Municipio_Comercializador.php",
                        success: function(data) {
                            document.location.href = 'Admin_Municipios_Comercializadores.php';
                        }
                    });
                });
            }
            $("#eliminar_municipio").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Verify/Verificar_Admin_Municipio_Comercializador_Registros.php",
