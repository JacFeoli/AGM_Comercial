    ...
    if ($_SESSION['timeout'] + 60 * 60 < time()) {
        ...
        while ($row_departamento = mysqli_fetch_assoc($query_departamento)) {
            $table = $table . "<tr>";
                ...
                $table = $table . "<td style='vertical-align:middle;'><a href='Admin_Departamentos.php?id_departamento_editar=" . $row_departamento['ID_TABLA'] . "'><button><img src='Images/pencil_edit.png' title='Editar' width='16' height='16' /></button></a></td>";
                $table = $table . "<td style='vertical-align:middle;'><a href='Admin_Departamentos.php?id_departamento_eliminar=" . $row_departamento['ID_TABLA'] . "'><button><img src='Images/gnome_edit_delete.png' title='Eliminar' width='16' height='16'/></button></a></td>";
            $table = $table . "</tr>";
        }
