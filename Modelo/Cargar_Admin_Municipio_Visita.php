    ...
    if ($_SESSION['timeout'] + 60 * 60 < time()) {
        ...
        while ($row_municipio = mysqli_fetch_assoc($query_municipio)) {
            $table = $table . "<tr>";
                ...
                $table = $table . "<td style='vertical-align:middle;'><a href='Admin_Municipios_Visitas.php?id_municipio_editar=" . $row_municipio['ID_TABLA'] . "'><button><img src='Images/pencil_edit.png' title='Editar' width='16' height='16' /></button></a></td>";
                $table = $table . "<td style='vertical-align:middle;'><a href='Admin_Municipios_Visitas.php?id_municipio_eliminar=" . $row_municipio['ID_TABLA'] . "'><button><img src='Images/gnome_edit_delete.png' title='Eliminar' width='16' height='16'/></button></a></td>";
            $table = $table . "</tr>";
        }
