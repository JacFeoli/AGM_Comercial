...
<script>
    ...
    function generarReporteMensual(sw, id_ano, id_mes) {
        window.open('Combos/Generar_Reporte_Fact_Reca_Oper.php?sw='+sw+'&id_ano='+id_ano+'&id_mes='+id_mes, 'Popup', 'width=750, height=600');
    }
    function generarReporteRango(sw, fecha_inicio, fecha_fin) {
        window.open('Combos/Generar_Reporte_Fact_Reca_Oper.php?sw='+sw+'&fecha_inicio='+fecha_inicio+'&fecha_fin='+fecha_fin, 'Popup', 'width=750, height=600');
    }
    //END REPORTES PDF
    //REPORTES EXCEL
    function generarExcelMensual(sw, id_ano, id_mes) {
        window.location.href = 'Combos/Generar_Excel_Fact_Reca_Oper.php?sw='+sw+'&id_ano='+id_ano+'&id_mes='+id_mes;
    }
    function generarExcelRango(sw, fecha_inicio, fecha_fin) {
        window.location.href = 'Combos/Generar_Excel_Fact_Reca_Oper.php?sw='+sw+'&fecha_inicio='+fecha_inicio+'&fecha_fin='+fecha_fin;
    }
    //END REPORTES EXCEL
</script>
<script>
    $(document).ready(function() {
        ...
        switch (sw) {
            case '4':
                ...
                $.ajax({
                    type: "POST",
                    url: "Modelo/Cargar_Paginacion_Resultados_Operadores.php",
                    dataType: "json",
                    data: "sw="+sw+
                    ...
                    success: function(data) {
                        ...
                        $("#pagination-mensual").twbsPagination({
                            ...
                            onPageClick: function (event, page) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "Modelo/Cargar_Resultados_Operadores.php",
                                    data: "sw="+sw+
                                          "&page="+page+
                                          "&id_ano_mensual="+id_ano_mensual+
                                          "&id_mes_mensual="+id_mes_mensual,
