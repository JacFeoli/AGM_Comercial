<?php
    ...
    if ($_SESSION['timeout'] + 60 * 60 < time()) {
        ...
        if (isset($_GET['editar'])) {
            ...
            mysqli_query($connection, "UPDATE facturacion_operadores_2
            ...
            echo "<script>";
                echo "document.location.href = '../Facturacion_Operadores.php'";
            echo "</script>";
        } else {
            if (isset($_GET['eliminar'])) {
                mysqli_query($connection, "DELETE FROM facturacion_operadores_2 WHERE ID_FACTURACION = " . $_GET['eliminar']);
                echo "<script>";
                    echo "document.location.href = '../Facturacion_Operadores.php'";
                echo "</script>";
            } else {
                ...
                $id_usuario = $_SESSION['id_user'];
                mysqli_query($connection, "INSERT INTO facturacion_operadores_2 (ID_OPERADOR, ID_COD_DPTO, ID_COD_MPIO, FECHA_FACTURA,
