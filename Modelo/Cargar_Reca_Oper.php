<?php
    ...
    if ($_SESSION['timeout'] + 60 * 60 < time()) {
        ...
        $query_reca_esp = mysqli_query($connection, "SELECT DEPT.NOMBRE AS DEPARTAMENTO, MUN.NOMBRE AS MUNICIPIO,
                                                            RO.ID_RECAUDO, FO.ID_FACTURACION,
                                                            O.ID_OPERADOR AS ID_OPERADOR,
                                                            O.NOMBRE AS OPERADOR, FO.PERIODO_FACTURA,
                                                            FO.VALOR_FACTURA, RO.VALOR_RECAUDO, RO.ESTADO_RECAUDO
                                                       FROM recaudo_operadores_2 RO,
                                                            facturacion_operadores_2 FO, departamentos_operadores_2 DEPT,
        ...
        while ($row_reca_esp = mysqli_fetch_assoc($query_reca_esp)) {
            $table = $table . "<tr>";
                ...
                $table = $table . "<td style='vertical-align:middle;'>" . $row_reca_esp['OPERADOR'] . "</td>";
                ...
                $table = $table . "<td style='vertical-align:middle;'><a href='Recaudo_Operadores.php?id_reca_operador_editar=" . $row_reca_esp['ID_RECAUDO'] . "'><button><img src='Images/search.png' title='Detalle' width='16' height='16' /></button></a></td>";
                $table = $table . "<td style='vertical-align:middle;'><a href='Recaudo_Operadores.php?id_reca_operador_eliminar=" . $row_reca_esp['ID_RECAUDO'] . "'><button><img src='Images/gnome_edit_delete.png' title='Eliminar' width='16' height='16'/></button></a></td>";
            $table = $table . "</tr>";
        }
