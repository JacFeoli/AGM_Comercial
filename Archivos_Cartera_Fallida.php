...
<html>
    <head>
        <title>AGM - Archivos Cargados Cartera Fallida</title>
        <meta charset="UTF-8" />
    ...
    <div class="modal fade" id="modalDetalleArchivoCarteraFallida" role="dialog">
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                                                ...
                                                                <li class="sidebar-dropdown active">
                                                                    ...
                                                                    <div style="display: block;" class="sidebar-submenu">
                                                                        <ul class="nav nav-pills nav-stacked">
                                                                            <li>
                                                                                <a href='Archivos_Cartera_Fallida.php'>
                                    ...
                                    <div class="col-md-9">
                                        <div class="rightcol">
                                            <h1>Archivos Cargados Cartera Fallida</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#informacion_archivos_cartera_fallida_tab" id="tab_informacion_archivos_cartera_fallida" aria-controls="informacion_archivos_cartera_fallida_tab" role="tab" data-toggle="tab">Información Archivos Cargados Cartera Fallida</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_archivos_cartera_fallida_tab">
                                                    <ul class="nav nav-pills ulclass_info" role="tablist">
                                                        <?php
                                                            ...
                                                            $query_select_ano = mysqli_query($connection, "SELECT DISTINCT(ACC.ANO_FACTURA) AS ANO_FACTURA, AN.ID_ANO AS ID_ANO "
                                                                                                        . "  FROM archivos_cargados_cartera_fallida_2 ACC, anos_2 AN "
                                                            ...
                                                            if (mysqli_num_rows($query_select_ano) != 0) {
                                                                ...
                                                                echo "<p class='message'>No se encontraron Archivos Cargados de Cartera Fallida.</p>";
                                                            }
                                                        ?>
                                                    </ul>
                                                    <h2></h2>
                                                    <div class="tab-content">
                                                        <input class="form-control input-text input-sm" type="text" placeholder="Buscar Archivo" name="buscar_archivo_cartera_fallida_info" id="buscar_archivo_cartera_fallida_info" />
                                                        <br />
                                                        <?php
                                                            $sw = 0;
                                                            ...
                                                            while ($row_select_ano = mysqli_fetch_assoc($query_select_ano)) {
                                                                ...
                                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_<?php echo $row_select_ano['ANO_FACTURA']; ?>_tab">
                                                                    <?php
                                                                        $query_select_archivos = mysqli_query($connection, "SELECT * FROM archivos_cargados_cartera_fallida_2 "
                                                                                                                         . " WHERE ANO_FACTURA = '" . $row_select_ano['ANO_FACTURA'] . "'"
        ...
        function paginacionAnos(array_id_ano, array_pagination, array_nombre_ano) {
            ...
            for (var i=0; i<array_id_ano.length; i++) {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: "archivo=cartera&sw=0&id_ano="+array_id_ano[i]+"&pagination="+array_pagination[i]+"&nombre_ano="+array_nombre_ano[i],
                        ...
                        $("#"+data[0]).twbsPagination({
                            ...
                            onPageClick: function(event, page) {
                                ...
                                $.ajax({
                                    ...
                                    dataType: "json",
                                    data: "archivo=cartera&sw=0"+"&id_ano="+data[3]+"&nombre_ano="+data[2]+"&page="+page,
                                    success: function(data) {
    ...
    <script>
        $(document).ready(function() {
            $("#buscar_archivo_cartera_fallida_info").focus();
            ...
            $("#buscar_archivo_cartera_fallida_info").keypress(function(e) {
                if (e.which == 13) {
                    var busqueda_archivo_cartera_fallida;
                    if ($(this).val() == "") {
                        busqueda_archivo_cartera_fallida = " ";
                    } else {
                        busqueda_archivo_cartera_fallida = $(this).val().toUpperCase();
                    }
                    ...
                    $.ajax({
                        ...
                        url: "Modelo/Cargar_Paginacion_Archivos.php",
                        dataType: "json",
                        data: "archivo=cartera&sw=1&id_ano="+id_ano+"&busqueda_archivo_cartera_fallida="+busqueda_archivo_cartera_fallida,
                        success: function(data) {
                            ...
                            $("#"+data[0]).twbsPagination({
                                ...
                                onPageClick: function(event, page) {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "Modelo/Cargar_Archivos.php",
                                        dataType: "json",
                                        data: "archivo=cartera&sw=1&busqueda_archivo_cartera_fallida="+data[4]+"&id_ano="+data[3]+"&nombre_ano="+data[2]+"&page="+page,
                                        success: function(data) {
                                            $("#loading-spinner-"+data[2]).css('display', 'none');
            ...
            $("#modalDetalleArchivoCarteraFallida").on('show.bs.modal', function(e) {
                ...
                $.ajax ({
                    ...
                    dataType: "json",
                    data: "archivo=cartera&detalle_id="+detalle_id,
                    success: function(data) {
