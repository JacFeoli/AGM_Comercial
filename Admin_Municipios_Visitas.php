...
<html>
    <head>
        <title>AGM - Admin. Municipios Visita</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="rightcol">
                                            <h1>Admin. Municipios Visitas</h1>
                                            <h2></h2>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_municipio_tab">
                                                    ...
                                                    <?php
                                                        $query_select_municipios = "SELECT * "
                                                                                   . "FROM municipios_visitas_2 MUN, departamentos_visitas_2 DEP "
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="crear_municipio_tab">
                                                    <?php
                                                        if (isset($_GET['id_municipio_editar'])) { ?>
                                                            <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_municipio" name="crear_municipio" action="<?php echo "Modelo/Crear_Admin_Municipio_Visita.php?editar=" . $_GET['id_municipio_editar']; ?>" method="post">
                                                        <?php
                                                            $query_select_municipio = mysqli_query($connection, "SELECT * FROM municipios_visitas_2 WHERE ID_TABLA = " . $_GET['id_municipio_editar']);
                                                        ...
                                                        <?php
                                                            ...
                                                            if (isset($_GET['id_municipio_eliminar'])) { ?>
                                                                <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_municipio" name="crear_municipio" action="<?php echo "Modelo/Crear_Admin_Municipio_Visita.php?eliminar=" . $_GET['id_municipio_eliminar']; ?>" method="post">
                                                            <?php
                                                                $query_select_municipio = mysqli_query($connection, "SELECT * FROM municipios_visitas_2 WHERE ID_TABLA = " . $_GET['id_municipio_eliminar']);
                                                                $row_municipio = mysqli_fetch_array($query_select_municipio);
                                                            ?>
                                                            ...
                                                            <?php
                                                                ...
                                                                <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_municipio" name="crear_municipio" action="<?php echo "Modelo/Crear_Admin_Municipio_Visita.php"; ?>" method="post">
                                                            <?php
                                                            }
                                                            ?>
                                                        <?php
                                                            ...
                                                            <div style="text-align: center;" class="col-xs-12">
                                                                <?php
                                                                    if (isset($_GET['id_municipio_editar'])) { ?>
                                                                        ...
                                                                        <button type="reset" class="btn btn-danger btn-sm font background-danger cursor" onclick="document.location.href = 'Admin_Municipios_Visitas.php'"><i style="font-size: 14px;" class="fas fa-times"></i>&nbsp;&nbsp;Cancelar</button>
                                                                    <?php
                                                                    } else {
                                                                        if (isset($_GET['id_municipio_eliminar'])) { ?>
        ...
        $(document).ready(function() {
            ...
            $("#buscar_municipio").keypress(function(e) {
                if (e.which == 13) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Modelo/Cargar_Paginacion_Admin_Municipio_Visita.php",
                        dataType: "json",
                        ...
                        success: function(data) {
                            ...
                            $("#pagination-municipio").twbsPagination({
                                ...
                                onPageClick: function (event, page) {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "Modelo/Cargar_Admin_Municipio_Visita.php",
                                        dataType: "json",
            ...
            if (id_municipio_editar == undefined && id_municipio_eliminar == undefined) {
                $("#btn_crear_municipio").click(function() {
                    ...
                    $.ajax({
                        ...
                        url: "Modelo/Crear_Admin_Municipio_Visita.php",
                        success: function(data) {
                            document.location.href = 'Admin_Municipios_Visitas.php';
                        }
                    });
                });
            }
            $("#eliminar_municipio").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Verify/Verificar_Admin_Municipio_Visita_Registros.php",
