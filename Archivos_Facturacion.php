...
<html>
    <head>
        <title>AGM - Archivos Cargados Facturación</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="rightcol">
                                            <h1>Archivos Cargados Facturación</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#informacion_archivos_facturacion_tab" id="tab_informacion_archivos_facturacion" aria-controls="informacion_archivos_facturacion_tab" role="tab" data-toggle="tab">Información Archivos Cargados Facturación</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_archivos_facturacion_tab">
                                                    <ul class="nav nav-pills ulclass_info" role="tablist">
                                                        <?php
                                                            ...
                                                            $query_select_ano = mysqli_query($connection, "SELECT DISTINCT(ACC.ANO_FACTURA) AS ANO_FACTURA, AN.ID_ANO AS ID_ANO "
                                                                                                        . "  FROM archivos_cargados_facturacion_2 ACC, anos_2 AN "
                                                        ...
                                                        <?php
                                                            ...
                                                            while ($row_select_ano = mysqli_fetch_assoc($query_select_ano)) {
                                                                ...
                                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_<?php echo $row_select_ano['ANO_FACTURA']; ?>_tab">
                                                                    <?php
                                                                        $query_select_archivos = mysqli_query($connection, "SELECT * FROM archivos_cargados_facturacion_2 "
                                                                                                                         . " WHERE ANO_FACTURA = '" . $row_select_ano['ANO_FACTURA'] . "'"
        ...
        function paginacionAnos(array_id_ano, array_pagination, array_nombre_ano) {
            ...
            for (var i=0; i<array_id_ano.length; i++) {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: "archivo=fact&sw=0&id_ano="+array_id_ano[i]+"&pagination="+array_pagination[i]+"&nombre_ano="+array_nombre_ano[i],
                        ...
                        $("#"+data[0]).twbsPagination({
                            ...
                            onPageClick: function(event, page) {
                                ...
                                $.ajax({
                                    ...
                                    dataType: "json",
                                    data: "archivo=fact&sw=0"+"&id_ano="+data[3]+"&nombre_ano="+data[2]+"&page="+page,
                                    success: function(data) {
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#tab_informacion_archivos_facturacion").on("click", function() {
                $("#buscar_archivo_facturacion_info").focus();
            });
            $("#buscar_archivo_facturacion_info").keypress(function(e) {
                if (e.which == 13) {
                    ...
                    $.ajax({
                        ...
                        url: "Modelo/Cargar_Paginacion_Archivos.php",
                        dataType: "json",
                        data: "archivo=fact&sw=1&id_ano="+id_ano+"&busqueda_archivo_facturacion="+busqueda_archivo_facturacion,
                        success: function(data) {
                            ...
                            $("#"+data[0]).twbsPagination({
                                ...
                                onPageClick: function(event, page) {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "Modelo/Cargar_Archivos.php",
                                        dataType: "json",
                                        data: "archivo=fact&sw=1&busqueda_archivo_facturacion="+data[4]+"&id_ano="+data[3]+"&nombre_ano="+data[2]+"&page="+page,
                                        success: function(data) {
                                            $("#loading-spinner-"+data[2]).css('display', 'none');
            ...
            $("#modalDetalleArchivoFacturacion").on('show.bs.modal', function(e) {
                ...
                $.ajax ({
                    ...
                    dataType: "json",
                    data: "archivo=fact&detalle_id="+detalle_id,
                    success: function(data) {
