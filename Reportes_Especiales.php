...
<html>
    <head>
        <title>AGM - Reporte Facturacion & Recaudo Municipio</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div id="rightcol" class="rightcol">
                                            <h1>Reportes Facturacion & Recaudo Municipio</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                ...
                                                <li role="presentation">
                                                    <a href="#reporte_contribuyente_tab" id="tab_reporte_contribuyente" aria-controls="reporte_contribuyente_tab" role="tab" data-toggle="tab">Contribuyente</a>
                                                </li>
                                                <li role="presentation">
								...
								<input type="hidden" id="id_ano_municipio" name="id_ano_municipio" value="" required="required" />
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="reporte_contribuyente_tab">
                                                    <form class="form-horizontal row-bottom-buffer row-top-buffer" id="reporte_contribuyente" name="reporte_contribuyente">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-7">
								<input type="hidden" id="id_contribuyente" name="id_contribuyente" value="" />
                                                                <input type="text" class="form-control input-text input-sm" id="contribuyente" name="contribuyente" placeholder="Contribuyente" data-toogle="tooltip" readonly="readonly" title="CONTRIBUYENTE" onclick="contribuyenteLiquidacion()" />
                                                            </div>
                                                            <label style="text-align: left; padding-top: 4px; white-space: nowrap;" class="col-xs-1 control-label row-label" for="periodo_contribuyente">Periodo:</label>
                                                            <div class="col-xs-3">
								<input type="hidden" id="id_ano_contribuyente" name="id_ano_contribuyente" value="" required="required" />
                                                                <input type="hidden" id="id_mes_contribuyente" name="id_mes_contribuyente" value="" required="required" />
                                                                <input type="hidden" id="mes_contribuyente" name="mes_contribuyente" value="" required="required" />
                                                                <input type="text" class="form-control input-text input-sm" id="periodo_contribuyente" name="periodo_contribuyente" placeholder="Periodo" required="required" data-toggle="tooltip" readonly="readonly" title="PERIODO" onclick="periodoLiquidaciones(2)" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-xs-12">
    ...
    <script>
        ...
        function resetFields(id_menu) {
            switch (id_menu) {
                case 0:
                    ...
                    break;
                case 1:
                    $("#id_ano_contribuyente").val("");
                    $("#id_mes_contribuyente").val("");
                    $("#mes_contribuyente").val("");
        ...
        //POPUPS
        function infoContribuyenteReca(id_contribuyente, contribuyente) {
            $("#id_contribuyente").val(id_contribuyente);
            $("#contribuyente").val(contribuyente);
            $("#periodo_contribuyente").focus();
        }
        function contribuyenteLiquidacion() {
        ...
        function infoPeriodoLiquidaciones(id_consulta, id_ano, id_mes, mes) {
            switch (id_consulta) {
                case '1':
                    ...
                    break;
                case '2':
                    $("#id_ano_contribuyente").val(id_ano);
                    $("#id_mes_contribuyente").val(id_mes);
                    $("#mes_contribuyente").val(mes);
                    $("#periodo_contribuyente").val(mes + " - " + id_ano);
                    break;
                case '5':
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#tab_reporte_contribuyente").on("shown.bs.tab", function() {
                sw = 1;
                $("#contribuyente").focus();
            });
            ...
            $("#tab_reporte_contribuyente").on("click", function() {
                sw = 1;
                $("#contribuyente").focus();
            });
                ...
                switch(sw) {
                    case 0:
                        ...
                        $.ajax({
                            ...
                            url: 'Modelo/Resultado_Liquidaciones.php',
                    ...
                    case 1:
                        ...
                        var periodo_contribuyente = $("#periodo_contribuyente").val();
                        if (contribuyente.length == 0) {
                            $("#contribuyente").focus();
                            return false;
                        }
                        if (periodo_contribuyente.length == 0) {
                            $("#periodo_contribuyente").focus();
                            return false;
                        }
                        //alert(contribuyente + " - " + id_ano_contribuyente + " - " + id_mes_contribuyente + " - " + periodo_contribuyente);
                        $("#btn_consultar").attr("disabled", true);
                        $("#btn_consultar").css("pointer-events", "none");
                        $("#btn_consultar").html("Generando Consulta...");
                        $.ajax({
                            ...
                            data: 'sw='+sw+
                                  ...
                                  '&periodo_contribuyente='+periodo_contribuyente,
                            url: 'Modelo/Resultado_Liquidaciones.php',
                            success: function(data) {
                                $("#rightcol").html(data);
                            }
    ...
    <script>
        $(document).ready(function(){
            ...
            $('input[type=text][name=periodo_contribuyente]').tooltip({
                container: "body",
                placement: "top"
            });
