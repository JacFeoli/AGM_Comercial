...
<html>
    <head>
        <title>AGM - Facturacion & Recaudo Electricaribe</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                                        ...
                                                        <div class="sidebar-menu">
                                                            <ul>
                                                                ...
                                                                <li class="sidebar-dropdown active">
                                                                    <a href='#'>
                                                                        <i style="background-color: #003153; color: #FFFFFF;" class="fas fa-search-dollar"></i>
                                                                        <span>Reasignar Recaudo</span>
                                                                    </a>
                                                                    <div style="display: block;" class="sidebar-submenu">
                                                                        <ul class="nav nav-pills nav-stacked">
                                                                            <li>
                                                                                <a href='Reasignar_Recaudo.php'>
                                                                                    <i style="background-color: #003153; color: #FFFFFF;" class="fas fa-search-dollar"></i>
                                                                                    <span>Reasignar Recaudo</span>
                                                                                </a>
                                                                            </li>
                                    ...
                                    <div class="col-md-9">
                                        <div class="rightcol">
                                            <h1>Reasignar Recaudo</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#reasignar_recaudo_tab" id="tab_reasignar_recaudo" aria-controls="reasignar_recaudo_tab" role="tab" data-toggle="tab">Reasignar Recaudo</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
