...
<html>
    <head>
        <title>AGM - Cargue Facturación</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="rightcol">
                                            <h1>Cargue Facturación</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#cargar_facturacion_tab" id="tab_cargar_facturacion" aria-controls="cargar_facturacion_tab" role="tab" data-toggle="tab">Cargar Facturación</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="cargar_facturacion_tab">
                                                    <form class="form-horizontal row-bottom-buffer row-top-buffer" id="cargar_facturacion" name="cargar_facturacion" action="Modelo/Subir_Archivos_Mes.php?archivo=facturacion" method="post" enctype="multipart/form-data">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#ano_factura").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=fact&ano_factura="+ano_factura,
            ...
            $("#mes_consolidado").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=fact&ano_factura="+ano_factura+"&mes_consolidado="+mes_consolidado,
            ...
            $("#departamento").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=fact&ano_factura="+ano_factura+"&mes_consolidado="+mes_consolidado+"&departamento="+departamento,
