...
<html>
    <head>
        <title>AGM - Archivos Cargados Novedades</title>
        <meta charset="UTF-8" />
    ...
    <div class="modal fade" id="modalDetalleArchivoNovedades" role="dialog">
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="rightcol">
                                            <h1>Archivos Cargados Novedades</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#informacion_archivos_novedades_tab" id="tab_informacion_archivos_novedades" aria-controls="informacion_archivos_novedades_tab" role="tab" data-toggle="tab">Información Archivos Cargados Novedades</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_archivos_novedades_tab">
                                                    <ul class="nav nav-pills ulclass_info" role="tablist">
                                                        <?php
                                                            $sw = 0;
                                                            $array_id_ano = array();
                                                            $array_nombre_ano = array();
                                                            $query_select_ano = mysqli_query($connection, "SELECT DISTINCT(ACN.ANO_FACTURA) AS ANO_FACTURA, AN.ID_ANO AS ID_ANO "
                                                                                                        . "  FROM archivos_cargados_novedades_2 ACN, anos_2 AN "
                                                                                                        . " WHERE ACN.ANO_FACTURA = AN.NOMBRE "
                                                                                                        . " ORDER BY AN.NOMBRE");
                                                            if (mysqli_num_rows($query_select_ano) != 0) {
                                                                ...
                                                                echo "<p class='message'>No se encontraron Archivos Cargados de Novedades.</p>";
                                                            }
                                                        ?>
                                                    </ul>
                                                    <h2></h2>
                                                    <div class="tab-content">
                                                        <input class="form-control input-text input-sm" type="text" placeholder="Buscar Archivo" name="buscar_archivo_novedades_info" id="buscar_archivo_novedades_info" />
                                                        <br />
                                                        <?php
                                                            $sw = 0;
                                                            $array_pagination = array();
                                                            $query_select_ano = mysqli_query($connection, "SELECT DISTINCT(ACN.ANO_FACTURA), AN.ID_ANO "
                                                                                                        . "  FROM archivos_cargados_novedades_2 ACN, anos_2 AN "
                                                                                                        . " WHERE ACN.ANO_FACTURA = AN.NOMBRE "
                                                                                                        . " ORDER BY AN.NOMBRE");
                                                            while ($row_select_ano = mysqli_fetch_assoc($query_select_ano)) {
                                                                ...
                                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_<?php echo $row_select_ano['ANO_FACTURA']; ?>_tab">
                                                                    <?php
                                                                        $query_select_archivos = mysqli_query($connection, "SELECT * FROM archivos_cargados_novedades_2 "
                                                                                                                         . " WHERE ANO_FACTURA = '" . $row_select_ano['ANO_FACTURA'] . "'"
        ...
        function paginacionAnos(array_id_ano, array_pagination, array_nombre_ano) {
            ...
            for (var i=0; i<array_id_ano.length; i++) {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: "archivo=nove&sw=0&id_ano="+array_id_ano[i]+"&pagination="+array_pagination[i]+"&nombre_ano="+array_nombre_ano[i],
                        ...
                        $("#"+data[0]).twbsPagination({
                            ...
                            onPageClick: function(event, page) {
                                ...
                                $.ajax({
                                    ...
                                    dataType: "json",
                                    data: "archivo=nove&sw=0"+"&id_ano="+data[3]+"&nombre_ano="+data[2]+"&page="+page,
                                    success: function(data) {
    ...
    <script>
        $(document).ready(function() {
            $("#buscar_archivo_novedades_info").focus();
            ...
            $("#tab_informacion_archivos_novedades").on("click", function() {
                $("#buscar_archivo_novedades_info").focus();
            });
            $("#buscar_archivo_novedades_info").keypress(function(e) {
                if (e.which == 13) {
                    var busqueda_archivo_novedades;
                    if ($(this).val() == "") {
                        busqueda_archivo_novedades = " ";
                    } else {
                        busqueda_archivo_novedades = $(this).val().toUpperCase();
                    }
                    ...
                    $.ajax({
                        ...
                        url: "Modelo/Cargar_Paginacion_Archivos.php",
                        dataType: "json",
                        data: "archivo=nove&sw=1&id_ano="+id_ano+"&busqueda_archivo_novedades="+busqueda_archivo_novedades,
                        success: function(data) {
                            ...
                            $("#"+data[0]).twbsPagination({
                                ...
                                onPageClick: function(event, page) {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "Modelo/Cargar_Archivos.php",
                                        dataType: "json",
                                        data: "archivo=nove&sw=1&busqueda_archivo_novedades="+data[4]+"&id_ano="+data[3]+"&nombre_ano="+data[2]+"&page="+page,
                                        success: function(data) {
                                            $("#loading-spinner-"+data[2]).css('display', 'none');
            ...
            $("#modalDetalleArchivoNovedades").on('show.bs.modal', function(e) {
                ...
                $.ajax ({
                    ...
                    dataType: "json",
                    data: "archivo=nove&detalle_id="+detalle_id,
                    success: function(data) {
