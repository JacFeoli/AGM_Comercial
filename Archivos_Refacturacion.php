...
<html>
    <head>
        <title>AGM - Archivos Cargados Refacturación</title>
        <meta charset="UTF-8" />
    ...
    <div class="modal fade" id="modalDetalleArchivoRefacturacion" role="dialog">
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                                                ...
                                                                <li class="sidebar-dropdown active">
                                                                    ...
                                                                    <div style="display: block;" class="sidebar-submenu">
                                                                        <ul class="nav nav-pills nav-stacked">
                                                                            <li>
                                                                                <a href='Archivos_Refacturacion.php'>
                                                                            ...
                                                                            <li>
                                                                                <a href='Cargue_Refacturacion.php'>
                                                                                    ...
                                                                                    <span>Cargue Refacturación</span>
                                                                                </a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="rightcol">
                                            <h1>Archivos Cargados Refacturación</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#informacion_archivos_refacturacion_tab" id="tab_informacion_archivos_refacturacion" aria-controls="informacion_archivos_refacturacion_tab" role="tab" data-toggle="tab">Información Archivos Cargados Refacturación</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_archivos_refacturacion_tab">
                                                    <ul class="nav nav-pills ulclass_info" role="tablist">
                                                        <?php
                                                            ...
                                                            $query_select_ano = mysqli_query($connection, "SELECT DISTINCT(ACC.ANO_FACTURA) AS ANO_FACTURA, AN.ID_ANO AS ID_ANO "
                                                                                                        . "  FROM archivos_cargados_refacturacion_2 ACC, anos_2 AN "
                                                            ...
                                                            if (mysqli_num_rows($query_select_ano) != 0) {
                                                                while ($row_select_ano = mysqli_fetch_assoc($query_select_ano)) {
                                                                    if ($sw == 0) {
                                                                        ...
                                                                        $query_select_count_registros = mysqli_query($connection, "SELECT ID_TABLA "
                                                                                                                                . "  FROM archivos_cargados_refacturacion_2 "
                                                                ...
                                                                echo "<p class='message'>No se encontraron Archivos Cargados de Refacturación.</p>";
                                                            }
                                                        ?>
                                                    </ul>
                                                    <h2></h2>
                                                    <div class="tab-content">
                                                        <input class="form-control input-text input-sm" type="text" placeholder="Buscar Archivo" name="buscar_archivo_refacturacion_info" id="buscar_archivo_refacturacion_info" />
                                                        <br />
                                                        <?php
                                                            $sw = 0;
                                                            ...
                                                            while ($row_select_ano = mysqli_fetch_assoc($query_select_ano)) {
                                                                ...
                                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_<?php echo $row_select_ano['ANO_FACTURA']; ?>_tab">
                                                                    <?php
                                                                        $query_select_archivos = mysqli_query($connection, "SELECT * FROM archivos_cargados_refacturacion_2 "
                                                                                                                         . " WHERE ANO_FACTURA = '" . $row_select_ano['ANO_FACTURA'] . "'"
        ...
        function paginacionAnos(array_id_ano, array_pagination, array_nombre_ano) {
            ...
            for (var i=0; i<array_id_ano.length; i++) {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: "archivo=refact&sw=0&id_ano="+array_id_ano[i]+"&pagination="+array_pagination[i]+"&nombre_ano="+array_nombre_ano[i],
                        ...
                        $("#"+data[0]).twbsPagination({
                            ...
                            onPageClick: function(event, page) {
                                ...
                                $.ajax({
                                    ...
                                    dataType: "json",
                                    data: "archivo=refact&sw=0"+"&id_ano="+data[3]+"&nombre_ano="+data[2]+"&page="+page,
                                    success: function(data) {
    ...
    <script>
        $(document).ready(function() {
            $("#buscar_archivo_refacturacion_info").focus();
            ...
            $("#tab_informacion_archivos_refacturacion").on("click", function() {
                $("#buscar_archivo_refacturacion_info").focus();
            });
            $("#buscar_archivo_refacturacion_info").keypress(function(e) {
                if (e.which == 13) {
                    var busqueda_archivo_refacturacion;
                    if ($(this).val() == "") {
                        busqueda_archivo_refacturacion = " ";
                    } else {
                        busqueda_archivo_refacturacion = $(this).val().toUpperCase();
                    }
                    ...
                    $.ajax({
                        ...
                        url: "Modelo/Cargar_Paginacion_Archivos.php",
                        dataType: "json",
                        data: "archivo=refact&sw=1&id_ano="+id_ano+"&busqueda_archivo_refacturacion="+busqueda_archivo_refacturacion,
                        success: function(data) {
                            ...
                            $("#"+data[0]).twbsPagination({
                                ...
                                onPageClick: function(event, page) {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "Modelo/Cargar_Archivos.php",
                                        dataType: "json",
                                        data: "archivo=refact&sw=1&busqueda_archivo_refacturacion="+data[4]+"&id_ano="+data[3]+"&nombre_ano="+data[2]+"&page="+page,
                                        success: function(data) {
                                            $("#loading-spinner-"+data[2]).css('display', 'none');
            ...
            $("#modalDetalleArchivoRefacturacion").on('show.bs.modal', function(e) {
                ...
                $.ajax ({
                    ...
                    dataType: "json",
                    data: "archivo=refact&detalle_id="+detalle_id,
                    success: function(data) {
