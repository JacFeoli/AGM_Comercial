                                            ...
                                            <?php
                                                if (isset($_GET['id_municipio']) && isset($_GET['id_departamento'])) {
                                                    ...
                                                    $query_select_municipio = mysqli_query($connection, "SELECT * "
                                                                                                      ...
                                                                                                      . "       municipios_operadores_2 MO, "
                                                                                                      . "       facturacion_operadores_2 FO "
                                                                                                      . " WHERE DOP.ID_DEPARTAMENTO = FO.ID_COD_DPTO "
                                                                                                      . "   AND MO.ID_MUNICIPIO = FO.ID_COD_MPIO "
                                                                                                      . "   AND DOP.ID_DEPARTAMENTO = MO.ID_DEPARTAMENTO "
                                                                                                      . "   AND MO.ID_DEPARTAMENTO = '" . $departamento . "' "
                                                                                                      . "   AND MO.ID_MUNICIPIO = '" . $_GET['id_municipio'] . "' "
                                                    ...
                                                    $id_consulta = $_GET['id_consulta'];
                                                    $id_operador = $_GET['id_operador'];
                                                    $query_select_all_municipio = mysqli_query($connection, "SELECT DISTINCT(MO.ID_MUNICIPIO), MO.NOMBRE "
                                                                                                          . "  FROM departamentos_operadores_2 DOP, "
                                                                                                          . "       municipios_operadores_2 MO, "
                                                                                                          . "       facturacion_operadores_2 FO "
                                                                                                          . " WHERE DOP.ID_DEPARTAMENTO = FO.ID_COD_DPTO "
                                                                                                          . "   AND MO.ID_MUNICIPIO = FO.ID_COD_MPIO "
                                                                                                          . "   AND DOP.ID_DEPARTAMENTO = MO.ID_DEPARTAMENTO "
                                                                                                          . "   AND DOP.ID_OPERADOR = FO.ID_OPERADOR "
                                                                                                          . "   AND MO.ID_OPERADOR = FO.ID_OPERADOR "
                                                                                                          . "   AND MO.ID_DEPARTAMENTO = '" . $departamento . "' "
                                                                                                          . "   AND MO.ID_OPERADOR = '" . $id_operador . "' "
                                                                                                          . " ORDER BY MO.NOMBRE");
                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_municipio = mysqli_fetch_assoc($query_select_all_municipio)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Municipio_Recaudo_Operador.php?id_departamento=" . $departamento . "&id_municipio=" . $row_all_municipio['ID_MUNICIPIO'] . "&id_consulta=" . $id_consulta . "&id_operador=" . $id_operador . "'>" . $row_all_municipio['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
