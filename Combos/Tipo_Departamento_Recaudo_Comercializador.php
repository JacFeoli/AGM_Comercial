                                            ...
                                            <?php
                                                if (isset($_GET['id_departamento'])) {
                                                    ...
                                                    $query_select_departamento = mysqli_query($connection, "SELECT * "
                                                                                                         . "  FROM departamentos_comercializadores_2 DC, facturacion_comercializadores_2 FC "
                                                                                                         . " WHERE DC.ID_DEPARTAMENTO = FC.ID_COD_DPTO "
                                                                                                         . "   AND DC.ID_DEPARTAMENTO = '" . $_GET['id_departamento'] . "' "
                                                                                                         . "   AND DC.ID_COMERCIALIZADOR = '" . $id_comercializador . "' ");
                                                    ...
                                                    $id_consulta = $_GET['id_consulta'];
                                                    $id_comercializador = $_GET['id_comercializador'];
                                                    $query_select_all_departamento = mysqli_query($connection, "SELECT DISTINCT(DC.ID_DEPARTAMENTO), DC.NOMBRE "
                                                                                                             . "  FROM departamentos_comercializadores_2 DC, facturacion_comercializadores_2 FC "
                                                                                                             . " WHERE DC.ID_COMERCIALIZADOR = FC.ID_COMERCIALIZADOR "
                                                                                                             . "   AND DC.ID_DEPARTAMENTO = FC.ID_COD_DPTO "
                                                                                                             . "   AND DC.ID_COMERCIALIZADOR = '" . $id_comercializador . "' "
                                                                                                             . " ORDER BY DC.NOMBRE");
                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_departamento = mysqli_fetch_assoc($query_select_all_departamento)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Departamento_Recaudo_Comercializador.php?id_departamento=" . $row_all_departamento['ID_DEPARTAMENTO'] . "&id_consulta=" . $id_consulta . "&id_comercializador=" . $id_comercializador . "'>" . $row_all_departamento['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
