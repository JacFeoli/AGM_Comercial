                                            ...
                                            <?php
                                                if (isset($_GET['id_departamento'])) {
                                                    ...
                                                    $query_select_departamento = mysqli_query($connection, "SELECT * "
                                                                                                         . "  FROM departamentos_visitas_2 DV, facturacion_municipales_2 FM "
                                                                                                         . " WHERE DV.ID_DEPARTAMENTO = FM.ID_COD_DPTO "
                                                                                                         . "   AND DV.ID_DEPARTAMENTO = '" . $_GET['id_departamento'] . "' ");
                                                    ...
                                                    $id_consulta = $_GET['id_consulta'];
                                                    $query_select_all_departamento = mysqli_query($connection, "SELECT DISTINCT(DV.ID_DEPARTAMENTO), DV.NOMBRE "
                                                                                                             . "  FROM departamentos_visitas_2 DV, facturacion_municipales_2 FM "
                                                                                                             . " WHERE DV.ID_DEPARTAMENTO = FM.ID_COD_DPTO "
                                                                                                             . " ORDER BY DV.NOMBRE");
                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_departamento = mysqli_fetch_assoc($query_select_all_departamento)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Departamento_Recaudo.php?id_departamento=" . $row_all_departamento['ID_DEPARTAMENTO'] . "&id_consulta=" . $id_consulta . "'>" . $row_all_departamento['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
