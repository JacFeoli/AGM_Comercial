                                        ...
                                        <div class="rightcol">
                                            ...
                                            <?php
                                                if(isset($_GET['id_departamento'])) {
                                                    ...
                                                    $query_select_departamento = mysqli_query($connection, "SELECT * FROM departamentos_2 WHERE ID_DEPARTAMENTO = '" . $_GET['id_departamento'] . "'");
                                                    ...
                                                    $id_consulta = $_GET['id_consulta'];
                                                    $query_select_all_departamento = mysqli_query($connection, "SELECT * FROM departamentos_2 ORDER BY NOMBRE");
                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_departamento = mysqli_fetch_assoc($query_select_all_departamento)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Departamento.php?id_departamento=" . $row_all_departamento['ID_DEPARTAMENTO'] . "&id_consulta=" . $id_consulta . "'>" . $row_all_departamento['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
