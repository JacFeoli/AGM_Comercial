...
<html>
    ...
    <script>
        function pasarOperadorFact() {
            window.opener.infoOperadorFact(document.getElementById("id_operador").value,
                                           document.getElementById("operador").value,
                                           document.getElementById("nit_operador").value);
            window.close();
        }
    </script>
    <body onload="javascript:pasarOperadorFact();">
        <div class="wrapper">
            <section>
                <div class="container">
                    <div class="row">
                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_operador = mysqli_fetch_assoc($query_select_all_operador)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Operador.php?id_operador=" . $row_all_operador['ID_OPERADOR'] . "'>" . $row_all_operador['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
