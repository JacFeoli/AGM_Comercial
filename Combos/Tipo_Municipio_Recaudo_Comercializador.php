                                            ...
                                            <?php
                                                if (isset($_GET['id_municipio']) && isset($_GET['id_departamento'])) {
                                                    ...
                                                    $query_select_municipio = mysqli_query($connection, "SELECT * "
                                                                                                      ...
                                                                                                      . "       municipios_comercializadores_2 MC, "
                                                                                                      . "       facturacion_comercializadores_2 FC "
                                                                                                      . " WHERE DC.ID_DEPARTAMENTO = FC.ID_COD_DPTO "
                                                                                                      . "   AND MC.ID_MUNICIPIO = FC.ID_COD_MPIO "
                                                                                                      . "   AND DC.ID_DEPARTAMENTO = MC.ID_DEPARTAMENTO "
                                                                                                      . "   AND MC.ID_DEPARTAMENTO = '" . $departamento . "' "
                                                                                                      . "   AND MC.ID_MUNICIPIO = '" . $_GET['id_municipio'] . "' "
                                                                                                      . "   AND MC.ID_COMERCIALIZADOR = '" . $id_comercializador . "' "
                                                                                                      . " ORDER BY DC.NOMBRE");
                                                    ...
                                                    $id_consulta = $_GET['id_consulta'];
                                                    $id_comercializador = $_GET['id_comercializador'];
                                                    $query_select_all_municipio = mysqli_query($connection, "SELECT DISTINCT(MC.ID_MUNICIPIO), MC.NOMBRE "
                                                                                                          . "  FROM departamentos_comercializadores_2 DC, "
                                                                                                          . "       municipios_comercializadores_2 MC, "
                                                                                                          . "       facturacion_comercializadores_2 FC "
                                                                                                          . " WHERE DC.ID_DEPARTAMENTO = FC.ID_COD_DPTO "
                                                                                                          . "   AND MC.ID_MUNICIPIO = FC.ID_COD_MPIO "
                                                                                                          . "   AND DC.ID_DEPARTAMENTO = MC.ID_DEPARTAMENTO "
                                                                                                          . "   AND DC.ID_COMERCIALIZADOR = FC.ID_COMERCIALIZADOR "
                                                                                                          . "   AND MC.ID_COMERCIALIZADOR = FC.ID_COMERCIALIZADOR "
                                                                                                          . "   AND MC.ID_DEPARTAMENTO = '" . $departamento . "' "
                                                                                                          . "   AND MC.ID_COMERCIALIZADOR = '" . $id_comercializador . "' "
                                                                                                          . " ORDER BY MC.NOMBRE");
                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_municipio = mysqli_fetch_assoc($query_select_all_municipio)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Municipio_Recaudo_Comercializador.php?id_departamento=" . $departamento . "&id_municipio=" . $row_all_municipio['ID_MUNICIPIO'] . "&id_consulta=" . $id_consulta . "&id_comercializador=" . $id_comercializador . "'>" . $row_all_municipio['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
