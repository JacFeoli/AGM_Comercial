                                        ...
                                        <div class="rightcol">
                                            ...
                                            <?php
                                                if (isset($_GET['id_municipio']) && isset($_GET['id_departamento'])) {
                                                    ...
                                                    $query_select_municipio = mysqli_query($connection, "SELECT * FROM municipios_2 WHERE ID_DEPARTAMENTO = '" . $departamento . "' AND ID_MUNICIPIO = '" . $_GET['id_municipio'] . "'");
                                                    ...
                                                    $departamento = $_GET['id_departamento'];
                                                    $id_consulta = $_GET['id_consulta'];
                                                    $query_select_all_municipio = mysqli_query($connection, "SELECT * FROM municipios_2 WHERE ID_DEPARTAMENTO = '" . $departamento . "' ORDER BY NOMBRE");
                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_municipio = mysqli_fetch_assoc($query_select_all_municipio)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Municipio.php?id_departamento=" . $departamento . "&id_municipio=" . $row_all_municipio['ID_MUNICIPIO'] . "&id_consulta=" . $id_consulta . "'>" . $row_all_municipio['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
