...
<html>
    ...
    <script>
        function pasarPeriodoNic() {
            window.opener.infoPeriodoNic(document.getElementById("id_consulta").value,
    ...
    <body onload="javascript:pasarPeriodoNic();">
        <div class="wrapper">
            <section>
                <div class="container">
                    <div class="row">
                                                                ...
                                                                while ($row_all_periodo = mysqli_fetch_assoc($query_select_all_periodo)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        if (strlen($row_all_periodo['ID_MES_FACTURA']) == 1) {
                                                                            echo "<td style='vertical-align:middle;'><a href='../Combos/Periodo_Nic.php?id_periodo=" . $row_all_periodo['ANO_FACTURA'] . "0" . $row_all_periodo['ID_MES_FACTURA'] . "&id_consulta=" . $id_consulta . "'>" . $row_all_periodo['MES_FACTURA'] . " - " . $row_all_periodo['ANO_FACTURA'] . "</a></td>";
                                                                        } else {
                                                                            echo "<td style='vertical-align:middle;'><a href='../Combos/Periodo_Nic.php?id_periodo=" . $row_all_periodo['ANO_FACTURA'] . $row_all_periodo['ID_MES_FACTURA'] . "&id_consulta=" . $id_consulta . "'>" . $row_all_periodo['MES_FACTURA'] . " - " . $row_all_periodo['ANO_FACTURA'] . "</a></td>";
                                                                        }
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
