                                            ...
                                            <?php
                                                if (isset($_GET['id_municipio']) && isset($_GET['id_departamento'])) {
                                                    ...
                                                    $query_select_municipio = mysqli_query($connection, "SELECT * "
                                                                                                      . "  FROM departamentos_visitas_2 DV, municipios_visitas_2 MV, facturacion_municipales_2 FM "
                                                                                                      . " WHERE DV.ID_DEPARTAMENTO = FM.ID_COD_DPTO "
                                                                                                      . "   AND MV.ID_MUNICIPIO = FM.ID_COD_MPIO "
                                                                                                      . "   AND DV.ID_DEPARTAMENTO = MV.ID_DEPARTAMENTO "
                                                                                                      . "   AND MV.ID_DEPARTAMENTO = " . $departamento
                                                                                                      . "   AND MV.ID_MUNICIPIO = " . $_GET['id_municipio']
                                                                                                      . " ORDER BY DV.NOMBRE");
                                                    ...
                                                    $departamento = $_GET['id_departamento'];
                                                    $id_consulta = $_GET['id_consulta'];
                                                    $query_select_all_municipio = mysqli_query($connection, "SELECT DISTINCT(MV.ID_MUNICIPIO), MV.NOMBRE "
                                                                                                             . "  FROM departamentos_visitas_2 DV, municipios_visitas_2 MV, facturacion_municipales_2 FM "
                                                                                                             . " WHERE DV.ID_DEPARTAMENTO = FM.ID_COD_DPTO "
                                                                                                             . "   AND MV.ID_MUNICIPIO = FM.ID_COD_MPIO "
                                                                                                             . "   AND DV.ID_DEPARTAMENTO = MV.ID_DEPARTAMENTO "
                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_municipio = mysqli_fetch_assoc($query_select_all_municipio)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Municipio_Recaudo.php?id_departamento=" . $departamento . "&id_municipio=" . $row_all_municipio['ID_MUNICIPIO'] . "&id_consulta=" . $id_consulta . "'>" . $row_all_municipio['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
