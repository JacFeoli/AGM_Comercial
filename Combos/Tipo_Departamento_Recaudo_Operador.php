                                            ...
                                            <?php
                                                if (isset($_GET['id_departamento'])) {
                                                    ...
                                                    $query_select_departamento = mysqli_query($connection, "SELECT * "
                                                                                                         . "  FROM departamentos_operadores_2 DOP, facturacion_operadores_2 FO "
                                                                                                         . " WHERE DOP.ID_DEPARTAMENTO = FO.ID_COD_DPTO "
                                                                                                         . "   AND DOP.ID_DEPARTAMENTO = '" . $_GET['id_departamento'] . "' "
                                                                                                         . "   AND DOP.ID_OPERADOR = '" . $id_operador . "' ");
                                                    ...
                                                    $id_consulta = $_GET['id_consulta'];
                                                    $id_operador = $_GET['id_operador'];
                                                    $query_select_all_departamento = mysqli_query($connection, "SELECT DISTINCT(DOP.ID_DEPARTAMENTO), DOP.NOMBRE "
                                                                                                             . "  FROM departamentos_operadores_2 DOP, facturacion_operadores_2 FO "
                                                                                                             . " WHERE DOP.ID_OPERADOR = FO.ID_OPERADOR "
                                                                                                             . "   AND DOP.ID_DEPARTAMENTO = FO.ID_COD_DPTO "
                                                                                                             . "   AND DOP.ID_OPERADOR = '" . $id_operador . "' "
                                                                                                             . " ORDER BY DOP.NOMBRE");
                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_departamento = mysqli_fetch_assoc($query_select_all_departamento)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Departamento_Recaudo_Operador.php?id_departamento=" . $row_all_departamento['ID_DEPARTAMENTO'] . "&id_consulta=" . $id_consulta . "&id_operador=" . $id_operador . "'>" . $row_all_departamento['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
