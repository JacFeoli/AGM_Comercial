    ...
    if ($_SESSION['timeout'] + 60 * 60 < time()) {
        ...
        switch ($sw) {
                    ...
                    <head>
                        <?php
                            if (strlen($_GET['id_mes']) == 1) { ?>
                                <title>AGM - Reporte Operadores Periodo <?php echo $_GET['id_ano'] . "0" . $_GET['id_mes']; ?></title>
                            <?php
                            } else { ?>
                                <title>AGM - Reporte Operadores Periodo <?php echo $_GET['id_ano'] . $_GET['id_mes']; ?></title>
                            <?php
                            }
                        ?>
                        <meta charset="UTF-8" />
                        ...
                        <table width="100%">
                            <td>
                                <table width="100%">
                                    <?php
                                        if (strlen($_GET['id_mes']) == 1) { ?>
                                            <tr><td style="font-size: 15px;"><center>REPORTE OPERADORES</center></td></tr>
            ...
            case '5':
                ...
                <html>
                    <head>
                        <title>AGM - Reporte Operadores Rango <?php echo $_GET['fecha_inicio'] . " & " . $_GET['fecha_fin']; ?></title>
                        <meta charset="UTF-8" />
                        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
                        <link rel="icon" href="../Images/agm_desarrollos_2_icon" type="image/x-icon" />
                    </head>
