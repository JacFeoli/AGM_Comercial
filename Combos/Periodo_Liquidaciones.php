...
<html>
    ...
    <script>
        function pasarPeriodoLiquidaciones() {
            window.opener.infoPeriodoLiquidaciones(document.getElementById("id_consulta").value,
    ...
    <body onload="javascript:pasarPeriodoLiquidaciones();">
        <div class="wrapper">
            <section>
                <div class="container">
                    <div class="row">
    ...
    <script>
        $(document).ready(function() {
            $("#btn_enviar").click(function() {
                ...
                document.location.href = '../Combos/Periodo_Liquidaciones.php?periodos='+periodos+'&id_consulta='+id_consulta;
            });
        });
    </script>
</html>