...
<html>
    <head>
        <title>AGM - Seleccionar Periodo Operador</title>
        <meta charset="UTF-8" />
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="rightcol">
                                            ...
                                            <h2></h2>
                                            <?php
                                                if(isset($_GET['id_facturacion']) && isset($_GET['id_operador']) && isset($_GET['id_departamento']) && isset($_GET['id_municipio'])) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        if (mysqli_num_rows($query_select_info_recaudo) != 0) {
                                                                            if ($row_info_recaudo['ESTADO_RECAUDO'] == 1) {
                                                                                ...
                                                                                echo "<td style='vertical-align:middle;'><a href='../Combos/Periodo_Reca_Oper.php?id_facturacion=" . $row_all_info_facturacion['ID_FACTURACION'] . "&id_operador=" . $id_operador . "&id_departamento=" . $id_departamento . "&id_municipio=" . $id_municipio . "'>" . $row_all_info_facturacion['PERIODO_FACTURA'] . "</a></td>";
                                                                            }
                                                                        } else {
                                                                            echo "<td style='vertical-align:middle;'><a href='../Combos/Periodo_Reca_Oper.php?id_facturacion=" . $row_all_info_facturacion['ID_FACTURACION'] . "&id_operador=" . $id_operador . "&id_departamento=" . $id_departamento . "&id_municipio=" . $id_municipio . "'>" . $row_all_info_facturacion['PERIODO_FACTURA'] . "</a></td>";
                                                                        }
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'>" . "<b style='font-size: 12px;'>$</b> " . number_format($row_all_info_facturacion['VALOR_FAVOR'], 0, ',', '.') . "</td>";
