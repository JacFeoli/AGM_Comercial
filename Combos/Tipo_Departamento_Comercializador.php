                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_departamento = mysqli_fetch_assoc($query_select_all_departamento)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Departamento_Comercializador.php?id_departamento=" . $row_all_departamento['ID_DEPARTAMENTO'] . "&id_consulta=" . $id_consulta . "&id_comercializador=" . $id_comercializador . "'>" . $row_all_departamento['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
