                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_municipio = mysqli_fetch_assoc($query_select_all_municipio)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Municipio_Operador.php?id_departamento=" . $departamento . "&id_municipio=" . $row_all_municipio['ID_MUNICIPIO'] . "&id_consulta=" . $id_consulta . "&id_operador=" . $id_operador . "'>" . $row_all_municipio['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
