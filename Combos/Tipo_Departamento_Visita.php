                                        ...
                                        <div class="rightcol">
                                            ...
                                            <?php
                                                if(isset($_GET['id_departamento'])) {
                                                    ...
                                                    $query_select_departamento = mysqli_query($connection, "SELECT * FROM departamentos_visitas_2 WHERE ID_DEPARTAMENTO = '" . $_GET['id_departamento'] . "'");
                                                    ...
                                                    if ($_SESSION['id_departamento'] != 0) {
                                                        $query_select_all_departamento = mysqli_query($connection, "SELECT * "
                                                                                                                 ...
                                                                                                                 . " WHERE ID_DEPARTAMENTO = " . $_SESSION['id_departamento'] . " "
                                                                                                                 .  "ORDER BY NOMBRE");
                                                    } else {
                                                        $query_select_all_departamento = mysqli_query($connection, "SELECT * FROM departamentos_visitas_2 ORDER BY NOMBRE");
                                                    }
                                                            ...
                                                            echo "<tbody>";
                                                                ...
                                                                while ($row_all_departamento = mysqli_fetch_assoc($query_select_all_departamento)) {
                                                                    ...
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td style='vertical-align:middle;'><a href='../Combos/Tipo_Departamento_Visita.php?id_departamento=" . $row_all_departamento['ID_DEPARTAMENTO'] . "&id_consulta=" . $id_consulta . "'>" . $row_all_departamento['NOMBRE'] . "</a></td>";
                                                                    echo "</tr>";
                                                                }
                                                            echo "</tbody>";
                                                        echo "</table>";
