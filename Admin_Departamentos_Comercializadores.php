...
<html>
    <head>
        <title>AGM - Admin. Departamentos Comercializadores</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="rightcol">
                                            <h1>Admin. Departamentos Comercializadores</h1>
                                            <h2></h2>
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_departamento_tab">
                                                    ...
                                                    <br />
                                                    <?php
                                                        $query_select_departamentos = "SELECT * FROM departamentos_comercializadores_2 ORDER BY NOMBRE";
                                                                ...
                                                                echo "<table class='table table-condensed table-hover'>";
                                                                    echo "<thead>";
                                                                        echo "<tr>";
                                                                            ...
                                                                            echo "<th width=55%>COMERCIALIZADOR</th>";
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="crear_departamento_tab">
                                                    <?php
                                                        if (isset($_GET['id_departamento_editar'])) { ?>
                                                            <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_departamento" name="crear_departamento" action="<?php echo "Modelo/Crear_Admin_Departamento_Comercializador.php?editar=" . $_GET['id_departamento_editar']; ?>" method="post">
                                                        <?php
                                                            $query_select_departamento = mysqli_query($connection, "SELECT * FROM departamentos_comercializadores_2 WHERE ID_TABLA = " . $_GET['id_departamento_editar']);
                                                        ...
                                                        <?php
                                                            ...
                                                            if (isset($_GET['id_departamento_eliminar'])) { ?>
                                                                <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_departamento" name="crear_departamento" action="<?php echo "Modelo/Crear_Admin_Departamento_Comercializador.php?eliminar=" . $_GET['id_departamento_eliminar']; ?>" method="post">
                                                            <?php
                                                                $query_select_departamento = mysqli_query($connection, "SELECT * FROM departamentos_comercializadores_2 WHERE ID_TABLA = " . $_GET['id_departamento_eliminar']);
                                                                $row_departamento = mysqli_fetch_array($query_select_departamento);
                                                            ?>
                                                            ...
                                                            <?php
                                                                ...
                                                                <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_departamento" name="crear_departamento" action="<?php echo "Modelo/Crear_Admin_Departamento_Comercializador.php"; ?>" method="post">
                                                            <?php
                                                            }
                                                            ?>
                                                        <?php
                                                    ...
                                                    ?>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-8">
                                                                <?php
                                                                    if (isset($_GET['id_departamento_editar'])) {
                                                                        $query_select_comercializador = mysqli_query($connection, "SELECT * FROM comercializadores_2 WHERE ID_COMERCIALIZADOR = " . $row_departamento['ID_COMERCIALIZADOR']);
                                                        ...
                                                        <div class="form-group">
                                                            <label style="text-align: left; padding-top: 4px; white-space: nowrap;" class="col-xs-1 control-label row-label" for="id_departamento">ID. Dpto.:</label>
                                                            <div class="col-xs-3">
                                                                <?php
                                                                    if (isset($_GET['id_departamento_editar'])) { ?>
                                                            ...
                                                            <label style="text-align: left; padding-top: 4px; white-space: nowrap;" class="col-xs-1 control-label row-label" for="nombre_departamento">Dpto.:</label>
                                                            <div class="col-xs-7">
                                                                <?php
                                                                    if (isset($_GET['id_departamento_editar'])) { ?>
                                                            ...
                                                            <div style="text-align: center;" class="col-xs-12">
                                                                <?php
                                                                    if (isset($_GET['id_departamento_editar'])) { ?>
                                                                        ...
                                                                        <button type="reset" class="btn btn-danger btn-sm font background-danger cursor" onclick="document.location.href = 'Admin_Departamentos_Comercializadores.php'"><i style="font-size: 14px;" class="fas fa-times"></i>&nbsp;&nbsp;Cancelar</button>
                                                                    <?php
                                                                    } else {
                                                                        if (isset($_GET['id_departamento_eliminar'])) { ?>
    ...
    <script>
        ...
        //POPUPS
        function infoComercializadorFact(id_comercializador, comercializador) {
        ...
        $(document).ready(function() {
            ...
            $("#buscar_departamento").keypress(function(e) {
                if (e.which == 13) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Modelo/Cargar_Paginacion_Admin_Departamento_Comercializador.php",
                        dataType: "json",
                        ...
                        success: function(data) {
                            ...
                            $("#pagination-departamento").twbsPagination({
                                ...
                                onPageClick: function (event, page) {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "Modelo/Cargar_Admin_Departamento_Comercializador.php",
                                        dataType: "json",
            ...
            if (id_departamento_editar == undefined && id_departamento_eliminar == undefined) {
                $("#btn_crear_departamento").click(function() {
                    ...
                    if (id_comercializador.length == 0) {
                        $("#comercializador").focus();
                        return false;
                    }
                    ...
                    $.ajax({
                        type: "POST",
                        data: "id_comercializador="+id_comercializador+"&id_departamento="+id_departamento+"&nombre_departamento="+nombre_departamento,
                        url: "Modelo/Crear_Admin_Departamento_Comercializador.php",
                        success: function(data) {
                            document.location.href = 'Admin_Departamentos_Comercializadores.php';
                        }
                    });
                });
            }
            $("#eliminar_departamento").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Verify/Verificar_Admin_Departamento_Comercializador_Registros.php",
