...
<html>
    <head>
        <title>AGM - Admin. Departamentos Visita</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="rightcol">
                                            <h1>Admin. Departamentos Visitas</h1>
                                            <h2></h2>
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="informacion_departamento_tab">
                                                    ...
                                                    <br />
                                                    <?php
                                                        $query_select_departamentos = "SELECT * FROM departamentos_visitas_2 ORDER BY NOMBRE";
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="crear_departamento_tab">
                                                    <?php
                                                        if (isset($_GET['id_departamento_editar'])) { ?>
                                                            <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_departamento" name="crear_departamento" action="<?php echo "Modelo/Crear_Admin_Departamento_Visita.php?editar=" . $_GET['id_departamento_editar']; ?>" method="post">
                                                        <?php
                                                            $query_select_departamento = mysqli_query($connection, "SELECT * FROM departamentos_visitas_2 WHERE ID_TABLA = " . $_GET['id_departamento_editar']);
                                                        ...
                                                        <?php
                                                            ...
                                                            if (isset($_GET['id_departamento_eliminar'])) { ?>
                                                                <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_departamento" name="crear_departamento" action="<?php echo "Modelo/Crear_Admin_Departamento_Visita.php?eliminar=" . $_GET['id_departamento_eliminar']; ?>" method="post">
                                                            <?php
                                                                $query_select_departamento = mysqli_query($connection, "SELECT * FROM departamentos_visitas_2 WHERE ID_TABLA = " . $_GET['id_departamento_eliminar']);
                                                                $row_departamento = mysqli_fetch_array($query_select_departamento);
                                                            ?>
                                                            ...
                                                            <?php
                                                                ...
                                                                <form class="form-horizontal row-bottom-buffer row-top-buffer" id="crear_departamento" name="crear_departamento" action="<?php echo "Modelo/Crear_Admin_Departamento_Visita.php"; ?>" method="post">
                                                            <?php
                                                            }
                                                            ?>
                                                        <?php
                                                            ...
                                                            <div style="text-align: center;" class="col-xs-12">
                                                                <?php
                                                                    if (isset($_GET['id_departamento_editar'])) { ?>
                                                                        ...
                                                                        <button type="reset" class="btn btn-danger btn-sm font background-danger cursor" onclick="document.location.href = 'Admin_Departamentos_Visitas.php'"><i style="font-size: 14px;" class="fas fa-times"></i>&nbsp;&nbsp;Cancelar</button>
                                                                    <?php
                                                                    } else {
                                                                        if (isset($_GET['id_departamento_eliminar'])) { ?>
        ...
        $(document).ready(function() {
            ...
            $("#buscar_departamento").keypress(function(e) {
                if (e.which == 13) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Modelo/Cargar_Paginacion_Admin_Departamento_Visita.php",
                        dataType: "json",
                        ...
                        success: function(data) {
                            ...
                            $("#pagination-departamento").twbsPagination({
                                ...
                                onPageClick: function (event, page) {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "Modelo/Cargar_Admin_Departamento_Visita.php",
                                        dataType: "json",
            ...
            if (id_departamento_editar == undefined && id_departamento_eliminar == undefined) {
                $("#btn_crear_departamento").click(function() {
                    ...
                    $.ajax({
                        ...
                        url: "Modelo/Crear_Admin_Departamento_Visita.php",
                        success: function(data) {
                            document.location.href = 'Admin_Departamentos_Visitas.php';
                        }
                    });
                });
            }
            $("#eliminar_departamento").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "Verify/Verificar_Admin_Departamento_Visita_Registros.php",
