...
<html>
    <head>
        <title>AGM - Cargue Liquidaciones</title>
        <meta charset="utf-8">
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                                                        ...
                                                                        <ul class="nav nav-pills nav-stacked">
                                                                            <li>
                                                                                <a href='Cargue_Liquidaciones.php'>
                                                                                    <i style="background-color: #003153; color: #FFFFFF;" class="fas fa-file-upload"></i>
                                                                                    <span>Cargue Liquidaciones</span>
                                                                                </a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="rightcol">
                                            <h1>Cargue Liquidaciones</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#cargar_liquidacion_tab" id="tab_cargar_liquidacion" aria-controls="cargar_liquidacion_tab" role="tab" data-toggle="tab">Cargar Liquidaciones</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="cargar_liquidacion_tab">
                                                    <form class="form-horizontal row-bottom-buffer row-top-buffer" id="cargar_liquidacion" name="cargar_liquidacion" action="Modelo/Subir_Liquidaciones_Mes.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div style="margin-bottom: 5px;" class="form-group">
                                                            <div class="col-xs-2">
                                                                <div class="styled-select">
                                                                    <select class="form-control input-text input-sm" id="operador_red" name="operador_red" data-toggle="tooltip" title="OPERADOR RED">
                                                                        <option value="" selected="selected">-</option>
                                                                        <option value="6">Afinia</option>
                                                                        <option value="7">Air-e</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-4">
                                                            ...
                                                            <div class="col-xs-12">
                                                                ...
                                                                <?php
                                                                    /*if (isset($_POST['upload_files'])) {
                                                                        ...
                                                                        $query_select_ruta = mysqli_query($connection, "SELECT * FROM archivos_cargados_facturacion_2 WHERE RUTA = '" . $filename . "'");
                                                                        if (mysqli_num_rows($query_select_ruta) == 0) {
                                                                            if (substr($filename, 0, 4) == 'FACT') {
                                                                                ...
                                                                                echo $fullpath = "D:/BASES DE DATOS/Consolidados/" . $ano_factura . "/". $mes_consolidado . "/Facturacion/" . $departamento . "/" . $municipio . "/" . $filename;
                                                                                echo "<br />";
                                                                                $data = file($fullpath);
                                                                                $i = 0;
                                                                                ...
                                                                                $query_select_filename = mysqli_query($connection, "SELECT * FROM archivos_cargados_facturacion_2 WHERE RUTA = '" . $filename . "'");
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#ano_factura").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=liq&ano_factura="+ano_factura,
            ...
            $("#mes_consolidado").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=liq&ano_factura="+ano_factura+"&mes_consolidado="+mes_consolidado,
            ...
            $("#departamento").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=liq&ano_factura="+ano_factura+"&mes_consolidado="+mes_consolidado+"&departamento="+departamento,
            ...
            $("#upload_files").click(function() {
                ...
                var operador_red = $("#operador_red").val();
            ...
            $("#modalUpload").on("hidden.bs.modal", function() {
                ...
                $("#operador_red").prop("selectedIndex", 0);
    ...
    <script>
        $(document).ready(function() {
            ...
            $('select[name=operador_red]').tooltip({
                container : "body",
                placement : "top"
            });
