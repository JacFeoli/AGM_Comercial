...
<html>
    <head>
        <title>AGM - Consultas Fact. & Reca.</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div id="rightcol" class="rightcol">
                                            <h1>Consultas Facturación & Recaudo</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                ...
                                                <li role="presentation">
                                                    <a href="#consulta_tarifa_tab" id="tab_consulta_tarifa" aria-controls="consulta_tarifa_tab" role="tab" data-toggle="tab">Por Tarifa</a>
                                                </li>
                                                <li role="presentation">
                                                    <a href="#consulta_cambio_tarifa_tab" id="tab_consulta_cambio_tarifa" aria-controls="consulta_cambio_tarifa_tab" role="tab" data-toggle="tab">Por Cambio Tarifa</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
								...
								<input type="hidden" id="id_ano_factura_departamento" name="id_ano_factura_departamento" value="" required="required" />
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="consulta_tarifa_tab">
                                                    <form class="form-horizontal row-bottom-buffer row-top-buffer" id="consultar_tarifa" name="consultar_tarifa">
                                                        <div class="form-group">
                                                            <div class="col-xs-3">
								<input type="hidden" id="id_tarifa" name="id_tarifa" value="" required="required" />
                                                                <input type="text" class="form-control input-text input-sm" id="tarifa" name="tarifa" placeholder="Tarifa" required="required" data-toggle="tooltip" readonly="readonly" title="TARIFA" onclick="tipoTarifa()" />
                                                            </div>
                                                            <div class="col-xs-3">
								<input type="hidden" id="id_departamento_tarifa" name="id_departamento_tarifa" value="" required="required" />
                                                                <input type="text" class="form-control input-text input-sm" id="departamento_tarifa" name="departamento_tarifa" placeholder="Departamento" required="required" data-toggle="tooltip" readonly="readonly" title="DEPARTAMENTO" onclick="tipoDepartamento(2)" />
                                                            </div>
                                                            <div class="col-xs-3">
								<input type="hidden" id="id_municipio_tarifa" name="id_municipio_tarifa" value="" required="required" />
                                                                <input type="text" class="form-control input-text input-sm" id="municipio_tarifa" name="municipio_tarifa" placeholder="Municipio" required="required" data-toggle="tooltip" readonly="readonly" title="MUNICIPIO" onclick="tipoMunicipio(2)" />
                                                            </div>
                                                            <div class="col-xs-3">
								<input type="hidden" id="id_ano_factura_tarifa" name="id_ano_factura_tarifa" value="" required="required" />
                                                                <input type="hidden" id="id_mes_factura_tarifa" name="id_mes_factura_tarifa" value="" required="required" />
                                                                <input type="hidden" id="mes_factura_tarifa" name="mes_factura_tarifa" value="" required="required" />
                                                                <input type="text" class="form-control input-text input-sm" id="periodo_tarifa" name="periodo_tarifa" placeholder="Periodo" required="required" data-toggle="tooltip" readonly="readonly" title="PERIODO" onclick="periodoNic(2)" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-xs-12">
                                                        ...
                                                        <div style="margin-bottom: 0px;" class="form-group">
                                                            <div style="text-align: center;" class="col-xs-12">
                                                                <button type="reset" class="btn btn-danger btn-sm font background-danger cursor" onclick="return resetFields(3);"><i style="font-size: 14px;" class="fas fa-times"></i>&nbsp;&nbsp;Cancelar</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                                <div role="tabpanel" class="tab-pane fade" id="consulta_cambio_tarifa_tab">
                                                    <form class="form-horizontal row-bottom-buffer row-top-buffer" id="consultar_cambio_tarifa" name="consultar_cambio_tarifa">
                                                        <div class="form-group">
                                                            <div class="col-xs-3">
								<input type="hidden" id="id_ano_cambio_tarifa" name="id_ano_cambio_tarifa" value="" required="required" />
                                                                <input type="hidden" id="id_mes_cambio_tarifa" name="id_mes_cambio_tarifa" value="" required="required" />
                                                                <input type="hidden" id="mes_cambio_tarifa" name="mes_cambio_tarifa" value="" required="required" />
                                                                <input type="text" class="form-control input-text input-sm" id="periodo_cambio_tarifa" name="periodo_cambio_tarifa" placeholder="Periodo" required="required" data-toggle="tooltip" readonly="readonly" title="PERIODO" onclick="periodoNic(3)" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-xs-12">
    ...
    <script>
        ...
        function resetFields(id_menu) {
            switch (id_menu) {
                ...
                case 3:
                    $("#id_tarifa").val("");
                    $("#id_ano_factura_tarifa").val("");
                    $("#id_mes_factura_tarifa").val("");
                    $("#mes_factura_tarifa").val("");
                    $("#id_departamento_tarifa").val("");
                    $("#id_municipio_tarifa").val("");
                    $("#tarifa").focus();
                    break;
                case 4:
                    $("#id_ano_cambio_tarifa").val("");
                    $("#id_mes_cambio_tarifa").val("");
                    $("#mes_cambio_tarifa").val("");
                    $("#periodo_cambio_tarifa").focus();
                    break;
            }
        }
        //POPUPS
        ...
        function infoTipoTarifa(id_tarifa, tarifa) {
            $("#id_tarifa").val(id_tarifa);
            $("#tarifa").val(tarifa);
            $("#id_departamento_tarifa").val("");
            $("#departamento_tarifa").val("");
            $("#departamento_tarifa").focus();
        }
        function tipoTarifa() {
            window.open("Combos/Tipo_Tarifa.php", "Popup", "width=400, height=500");
        }
        //END POPUPS
    </script>
    <script>
        $(document).ready(function() {
            ...
            $("#tab_consulta_tarifa").on("shown.bs.tab", function() {
                sw = 3;
                $("#tarifa").focus();
            });
            $("#tab_consulta_cambio_tarifa").on("shown.bs.tab", function() {
                sw = 4;
                $("#periodo_cambio_tarifa").focus();
            });
            ...
            $("#tab_consulta_tarifa").on("click", function() {
                sw = 3;
                $("#tarifa").focus();
            });
            $("#tab_consulta_cambio_tarifa").on("click", function() {
                sw = 4;
                $("#periodo_cambio_tarifa").focus();
            });
                ...
                switch(sw) {
                    case 0:
                        ...
                        $.ajax({
                            type: 'POST',
                            data: 'sw='+sw+'&nic='+nic,
                            url: 'Modelo/Resultado_Busqueda.php',
                    ...
                    case 3:
                        ...
                        var departamento = $("#id_departamento_tarifa").val();
                        var municipio = $("#id_municipio_tarifa").val();
                        var id_ano_factura = $("#id_ano_factura_tarifa").val();
                        var id_mes_factura = $("#id_mes_factura_tarifa").val();
                        var mes_factura = $("#mes_factura_tarifa").val();
                        if (tarifa.length == 0) {
                            $("#tarifa").focus();
                            return false;
                        }
                        ...
                        $.ajax({
                            type: 'POST',
                            data: 'sw='+sw+'&tarifa='+tarifa+'&departamento='+departamento+'&municipio='+municipio+
                                  '&id_ano_factura='+id_ano_factura+'&id_mes_factura='+id_mes_factura+
                                  '&mes_factura='+mes_factura,
                            url: 'Modelo/Resultado_Busqueda.php',
                            success: function(data) {
                    ...
                    case 4:
                        ...
                        if (id_ano_cambio_tarifa.length == 0) {
                            $("#periodo_cambio_tarifa").focus();
                            return false;
                        }
                        $("#btn_consultar").attr("disabled", true);
                        ...
                        $.ajax({
                            type: 'POST',
                            data: 'sw='+sw+'&id_ano_cambio_tarifa='+id_ano_cambio_tarifa+
    ...
    <script>
        $(document).ready(function(){
            ...
            $('input[type=text][name=departamento_tarifa]').tooltip({
                container: "body",
                placement: "top"
            });
            $('input[type=text][name=municipio_tarifa]').tooltip({
                container: "body",
                placement: "top"
            });
            $('input[type=text][name=periodo_tarifa]').tooltip({
                container: "body",
                placement: "top"
            });
            $('input[type=text][name=periodo_cambio_tarifa]').tooltip({
                container: "body",
                placement: "right"
            });
            $("#menu_home").tooltip({
