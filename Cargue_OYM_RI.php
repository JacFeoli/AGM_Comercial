                                        ...
                                        <div class="rightcol">
                                            ...
                                            <ul class="nav nav-pills" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#cargar_oym_ri_tab" id="tab_cargar_oym_ri" aria-controls="cargar_oym_ri_tab" role="tab" data-toggle="tab">Cargar OYM - RI</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="cargar_oym_ri_tab">
                                                    <form class="form-horizontal row-bottom-buffer row-top-buffer" id="cargar_oym_ri" name="cargar_oym_ri" action="Modelo/Subir_Archivos_Mes.php?archivo=oymri" method="post" enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-3">
                                                                <div class="styled-select">
                                                                    <select class="form-control input-text input-sm" id="periodo_factura" name="periodo_factura" data-toggle="tooltip" title="PERIODO">
                                                                        <option value="" selected="selected">-</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#ano_factura").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=oymri&ano_factura="+ano_factura,
                    url: "Modelo/Cargar_Periodos.php",
                    success: function(data) {
                        $("#loading-spinner").css("display", "none");
                        $("#periodo_factura").html(data);
            ...
            $("#modalUpload").on("hidden.bs.modal", function() {
                ...
                $("#periodo_factura").prop("selectedIndex", 0);
                $("#files").val("");
