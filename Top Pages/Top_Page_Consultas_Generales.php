                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li id='menu_consultas_grales' data-toogle='tooltip' title='CONSULTAS GRALES'><a href="Consultas_Generales_FR.php"><i style="font-size: 33px; padding: 5px 15px;" class="fas fa-tasks"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
