                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li id='menu_administrador' data-toogle='tooltip' title='ADMINISTRADOR CONTENIDO'><a href="Administrador_Contenido.php"><i style="font-size: 33px; padding: 5px 8px;" class="fas fa-cogs"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
