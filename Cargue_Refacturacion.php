...
<html>
    <head>
        <title>AGM - Cargue Refacturación</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="rightcol">
                                            <h1>Cargue Refacturación</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#cargar_refacturacion_tab" id="tab_cargar_refacturacion" aria-controls="cargar_refacturacion_tab" role="tab" data-toggle="tab">Cargar Refacturación</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="cargar_refacturacion_tab">
                                                    <form class="form-horizontal row-bottom-buffer row-top-buffer" id="cargar_refacturacion" name="cargar_refacturacion" action="Modelo/Subir_Archivos_Mes.php?archivo=refacturacion" method="post" enctype="multipart/form-data">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#ano_factura").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=refact&ano_factura="+ano_factura,
            ...
            $("#mes_consolidado").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=refact&ano_factura="+ano_factura+"&mes_consolidado="+mes_consolidado,
            ...
            $("#departamento").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=refact&ano_factura="+ano_factura+"&mes_consolidado="+mes_consolidado+"&departamento="+departamento,
            ...
            $("#upload_files").click(function() {
                ...
                $("#cargar_refacturacion").ajaxSubmit({
                    beforeSend: function() {
