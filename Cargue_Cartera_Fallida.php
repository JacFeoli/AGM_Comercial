...
<html>
    <head>
        <title>AGM - Cargue Cartera Fallida</title>
        <meta charset="UTF-8" />
                        ...
                        <div class="col-lg-12">
                            <div class="content">
                                <div class="row">
                                                                        ...
                                                                        <ul class="nav nav-pills nav-stacked">
                                                                            <li>
                                                                                <a href='Cargue_Cartera_Fallida.php'>
                                                                                    ...
                                                                                    <span>Cargue Cartera Fallida</span>
                                                                                </a>
                                                                            </li>
                                                                            <li>
                                    ...
                                    <div class="col-md-9">
                                        <div class="rightcol">
                                            <h1>Cargue Cartera Fallida</h1>
                                            <h2></h2>
                                            <ul class="nav nav-pills" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#cargar_cartera_fallida_tab" id="tab_cargar_cartera_fallida" aria-controls="cargar_cartera_fallida_tab" role="tab" data-toggle="tab">Cargar Cartera Fallida</a>
                                                </li>
                                            </ul>
                                            <h2></h2>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active" id="cargar_cartera_fallida_tab">
                                                    <form class="form-horizontal row-bottom-buffer row-top-buffer" id="cargar_cartera_fallida" name="cargar_cartera_fallida" action="Modelo/Subir_Archivos_Mes.php?archivo=cartera" method="post" enctype="multipart/form-data">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#ano_factura").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=cartera&ano_factura="+ano_factura,
            ...
            $("#departamento").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    data: "sw=cartera&ano_factura="+ano_factura+"&departamento="+departamento,
            ...
            $("#upload_files").click(function() {
                ...
                $("#cargar_cartera_fallida").ajaxSubmit({
                    beforeSend: function() {
